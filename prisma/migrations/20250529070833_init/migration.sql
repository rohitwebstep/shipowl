...
-- AddForeignKey
ALTER TABLE `supplierProductVariant` ADD CONSTRAINT `supplierProductVariant_supplierId_fkey` FOREIGN KEY (`supplierId`) REFERENCES `admin`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
-- AddForeignKey
ALTER TABLE `dropshipperProductVariant` ADD CONSTRAINT `dropshipperProductVariant_dropshipperId_fkey` FOREIGN KEY (`dropshipperId`) REFERENCES `admin`(`id`) ON DELETE CASCADE ON UPDATE CASCADE;
