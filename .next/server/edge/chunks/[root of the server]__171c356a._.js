(globalThis.TURBOPACK = globalThis.TURBOPACK || []).push(["chunks/[root of the server]__171c356a._.js", {
...
async function adminAuthMiddleware(req) {
    try {
        ...
        console.log(`payload.adminId - `, payload.adminId);
        ...
        const admin = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].admin.findUnique({
            where: {
                id: parseInt(payload.adminId, 10)
            },
            select: {
                id: true,
                name: true,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__171c356a._.js.map