...
__turbopack_context__.s({
    ...
    "getPermissionsOfAdmin": (()=>getPermissionsOfAdmin)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
...
const getPermissionsOfAdmin = async (adminId)=>{
    try {
        ...
        const permissions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminHasPermission.findMany({
            where: {
                adminId
            },
            include: {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])("error", `Failed to get permissions for adminId ${adminId}`, error);
        return {
            status: false,
...
"[project]/src/utils/auth/checkAdminPermission.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
;
;
async function checkAdminPermission({ admin_id, admin_type, panel, role, module, action }) {
    // Check if the user exists
    const userCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$authUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isUserExist"])(admin_id, role);
    if (!userCheck.status) {
    ...
    const getPermissionsOfAdminResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPermissionsOfAdmin"])(admin_id);
    if (getPermissionsOfAdminResult.status && Array.isArray(getPermissionsOfAdminResult.permissions)) {
        const hasPermission = getPermissionsOfAdminResult.permissions.some((perm)=>{
            return perm.permission && perm.permission.panel === panel && perm.permission.module === module && perm.permission.action === action && perm.permission.status === true;
        });
        if (hasPermission) {
            return {
                status: true,
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2f$checkAdminPermission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/auth/checkAdminPermission.ts [app-route] (ecmascript)");
...
async function POST(req) {
    ...
    const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2f$checkAdminPermission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkAdminPermission"])({
        admin_id: 1,
        admin_type: "main",
        panel: "admin",
        role: "admin",
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a5dbdb75._.js.map