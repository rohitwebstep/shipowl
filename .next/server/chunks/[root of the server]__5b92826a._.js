...
async function uploadToFTP(localPath, remoteFileName) {
    ...
    try {
        ...
        console.log("📁 Relative path after 'uploads':", relativePath);
        console.log("📂 Nested FTP directory to ensure:", dirPath);
        // Go to root
        await client.cd('/');
        console.log("📍 Changed to FTP root '/'");
        ...
        for (const folder of dirParts){
            try {
                console.log(`➡️ Ensuring nested folder: ${folder}`);
        ...
        console.log(`✅ Successfully uploaded: ${remoteFileName}`);
        await client.close();
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5b92826a._.js.map