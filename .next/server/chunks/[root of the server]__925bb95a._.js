 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "D:\\Webstep2\\NEW\\Shipping Owl\\May\\08\\working\\shipping-owl\\prisma\\prisma\\generated\\client",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "D:\\Webstep2\\NEW\\Shipping Owl\\May\\08\\working\\shipping-owl\\prisma\\schema.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    "inlineSchemaHash": "9ba417fac8577fe5e9520dc91f2c30987c3a93fa2209e1dd59c9187153f210c1",
    "copyEngine": true
};
...
"[project]/src/app/models/admin/admin.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "getAdminsByStatus": (()=>getAdminsByStatus),
...
async function checkEmailAvailability(email) {
    try {
        ...
        const existingAdmin = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.findFirst({
            where: {
                email
            },
            select: {
...
async function checkEmailAvailabilityForUpdate(email, adminId) {
    try {
        // Query to find if an email already exists with role 'admin'
        const existingAdmin = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.findFirst({
            where: {
...
async function createAdmin(adminId, adminRole, admin) {
    try {
        ...
        return {
            status: true,
            admin: serializeBigInt(newAdmin)
        };
    } catch (error) {
        console.error(`Error creating city:`, error);
        return {
...
const getAdminsByStatus = async (status = "notDeleted", withPassword = false)=>{
    try {
        let whereCondition = {};
        switch(status){
            case "notDeleted":
...
const getAdminById = async (id, withPassword = false)=>{
    try {
...
const updateAdmin = async (adminId, adminRole, admin, withPassword = false)=>{
    try {
        const { name, type, profilePicture, email, website, referralCode, phoneNumber, permanentAddress, permanentPostalCode, permanentCity, permanentState, permanentCountry, status: statusRaw, updatedAt, updatedBy, updatedByRole } = admin;
        // Convert statusRaw to a boolean using the includes check
        const status = [
            'true',
            '1',
        ...
        if (profilePicture && profilePicture.trim() !== '' && currentAdmin?.profilePicture?.trim()) {
            try {
                const imageFileName = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(currentAdmin.profilePicture.trim());
                const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'uploads', 'admin');
        ...
        const newAdmin = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.update({
            where: {
                id: adminId
            },
            data: updateData
...
const softDeleteAdmin = async (adminId, adminRole, id)=>{
    try {
        // Soft delete the admin
        const updatedAdmin = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.update({
            where: {
                id,
                role: 'admin'
            },
...
const restoreAdmin = async (adminId, adminRole, id)=>{
    try {
        // Restore the admin
        const restoredAdmin = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.update({
            where: {
                id
            },
            include: {
...
"[project]/src/app/models/admin/permission.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "assignAdminPermission": (()=>assignAdminPermission),
    "getAdminPermissionById": (()=>getAdminPermissionById),
    "getAdminPermissionsByStatus": (()=>getAdminPermissionsByStatus),
    "getAllAdminPermissions": (()=>getAllAdminPermissions)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/commonUtils.ts [app-route] (ecmascript)");
;
...
const getAdminPermissionById = async (id)=>{
    try {
        const permission = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].permission.findUnique({
            where: {
                id
            }
        });
...
async function assignAdminPermission(adminId, adminRole, payload) {
    try {
        const permissionOperations = payload.permissions.map(async (permission)=>{
            ...
            if (!found || !currentPermission) {
                return {
                    status: false,
                    message: message || "Permission record not found."
                };
            }
            // Check if the permission is already assigned to this admin
            const existingPermission = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminHasPermission.findFirst({
                where: {
            ...
            const newPermission = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminHasPermission.create({
                data: {
                    adminId: targetAdminId,
                    permissionId: targetPermissionId,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])("error", "Error while updating/creating admin permissions", error);
        return {
            status: false,
            message: "Internal Server Error"
        };
...
const getAllAdminPermissions = async ()=>{
    try {
        const permissions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].permission.findMany({
            orderBy: {
                id: 'desc'
            }
        });
...
const getAdminPermissionsByStatus = async (status)=>{
    try {
        let whereCondition = {};
        switch(status){
            case "active":
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/admin/admin.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/admin/permission.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(req) {
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'POST request received for admin creation');
        ...
        if (!type || ![
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', `Invalid type: ${type}`);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
        ...
        const { status: checkEmailAvailabilityResult, message: checkEmailAvailabilityMessage } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkEmailAvailability"])(email);
        ...
        const isLocationHierarchyCorrectResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$location$2f$city$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isLocationHierarchyCorrect"])(permanentCityId, permanentStateId, permanentCountryId);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Location hierarchy check result:', isLocationHierarchyCorrectResult);
        if (!isLocationHierarchyCorrectResult.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', `Location hierarchy is incorrect: ${isLocationHierarchyCorrectResult.message}`);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                message: isLocationHierarchyCorrectResult.message || 'Location hierarchy is incorrect'
            }, {
                status: 400
            });
        }
        ...
        const adminUploadDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'uploads', 'admin');
        ...
        for (const field of adminFileFields){
            ...
            if (fileData) {
                ...
                if (Array.isArray(fileData)) {
                    adminUploadedFiles[field] = fileData.map((file)=>file.url).join(', ');
                } else {
                    adminUploadedFiles[field] = fileData.url;
                }
            }
        }
        const adminPayload = {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Admin payload created:', adminPayload);
        const adminCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdmin"])(adminId, String(adminRole), adminPayload);
        if (!adminCreateResult || !adminCreateResult.status || !adminCreateResult.admin) {
            ...
            if (Object.keys(adminUploadedFiles).length > 0) {
                ...
                for(const field in adminUploadedFiles){
                    ...
                    for (const fileUrl of fileUrls){
                        if (fileUrl) {
                            const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(adminUploadDir, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(fileUrl));
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Admin creation failed:', adminCreateResult?.message || 'Unknown error');
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: adminCreateResult?.message || 'Admin creation failed'
            }, {
                status: 500
            });
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Admin\'s bank accounts:', permissions);
        ...
        const adminPermissionCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assignAdminPermission"])(adminId, String(adminRole), adminPermissionPayload);
        if (!adminPermissionCreateResult || !adminPermissionCreateResult.status || !adminPermissionCreateResult.permissions) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Admin company creation failed', adminPermissionCreateResult?.message);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: true,
            error: adminCreateResult?.message || 'Admin created Successfuly'
        }, {
            status: 200
        });
    } catch (err) {
        const error = err instanceof Error ? err.message : 'Internal Server Error';
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Admin Creation Error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error
        }, {
...
async function GET(req) {
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'GET request received for fetching admins');
        ...
        // Fetch all admins
        const adminsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$admin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAdminsByStatus"])("notDeleted");
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'No admins found');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Error fetching admins:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__925bb95a._.js.map