...
async function POST(req) {
    try {
        ...
        return;
        "TURBOPACK unreachable";
        const requiredFields = undefined;
        const formData = undefined;
        const validation = undefined;
        const extractNumber = undefined;
        const extractString = undefined;
        const extractJSON = undefined;
        const statusRaw = undefined;
        const status = undefined;
        const isVisibleToAllRaw = undefined;
        const isVisibleToAll = undefined;
        const isVarientExistsRaw = undefined;
        const isVarientExists = undefined;
        let supplierIds;
        const main_sku = undefined;
        const checkMainSKUAvailabilityResult = undefined, checkMainSKUAvailabilityMessage = undefined;
        const rawVariants = undefined;
        const variants = undefined;
        const brandId = undefined;
        const brandResult = undefined;
        const categoryId = undefined;
        const categoryResult = undefined;
        const originCountryId = undefined;
        const originCountryResult = undefined;
        const shippingCountryId = undefined;
        const shippingCountryResult = undefined;
        const uploadDir = undefined;
        const fileFields = undefined;
        const uploadedFiles = undefined;
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__09a585aa._.js.map