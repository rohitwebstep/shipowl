...
"[project]/.next-internal/server/app/api/admin/auth/forget/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "D:\\Webstep\\Shipping OWL\\2025\\April\\12\\WORKING\\sleeping-owl\\prisma\\prisma\\generated\\client",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "D:\\Webstep\\Shipping OWL\\2025\\April\\12\\WORKING\\sleeping-owl\\prisma\\schema.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    "inlineSchemaHash": "d0a32d2d07b938b357439b509b030f177ae9e4063b088986640c0290f0b9c644",
    "copyEngine": true
};
    ...
    try {
        ...
        const mailData = {
            ...
            bcc: [
                {
                    name: "Vansh Webstep",
                    email: "vanshwebstep@gmail.com"
                }
            ],
            subject: "Your Monthly Report",
            htmlBody: `
              <h2>Hello,</h2>
              <p>Please find your monthly report attached below.</p>
              <p>Regards,<br>Inspire Tuition</p>
            `,
            attachments: [
                {
                    name: "dummy.pdf",
                    path: "https://morth.nic.in/sites/default/files/dd12-13_0.pdf"
                }
            ]
        };
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$email$2f$sendEmail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendEmail"])(smtpConfig, mailData);
        if (result.success) {
...
async function handleForgetPassword(req, adminRole, adminStaffRole) {
    try {
        ...
        // Try fetching admin or adminStaff
        let adminResponse = await adminByUsernameRole(email, adminRole);
        if (!adminResponse.status || !adminResponse.admin) {
            adminResponse = await adminByUsernameRole(email, adminStaffRole);
            if (!adminResponse.status || !adminResponse.admin) {
        ...
        const admin = adminResponse.admin;
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$authUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generatePasswordResetToken"])(admin.id, adminRole); // 1h expiry by default
...
"[project]/src/app/api/admin/auth/forget/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__00de66a0._.js.map