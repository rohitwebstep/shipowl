...
async function PUT(req) {
    try {
        ...
        const bankAccountUploadDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'tmp', 'uploads', 'supplier', `${supplierId}`, 'bank-aacount');
