...
"[project]/.next-internal/server/app/api/supplier/profile/bank-account/request/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/supplier/profile/bank-account/request/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'POST request received for supplier bank account update');
        // Extract headers
        ...
        if (!supplierIdHeader || isNaN(supplierId)) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid or missing supplierIdHeader'
            }, {
                status: 400
            });
        }
        ...
        const currentBankAccountChangeRequest = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$bankAccount$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBankAccountChangeRequestByAdminId"])(supplierId);
        if (currentBankAccountChangeRequest.status) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                message: 'A bank account change request already exists for this supplier.'
        ...
        // Handle file uploads
        const supplierBankAccountUploadedFiles = {};
        for (const field of supplierBankAccountFileFields){
            ...
            if (fileData) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `Uploaded ${field} file data:`, fileData);
                if (Array.isArray(fileData)) {
                    supplierBankAccountUploadedFiles[field] = fileData.map((file)=>file.url).join(', ');
                } else {
                    supplierBankAccountUploadedFiles[field] = fileData.url;
                }
            }
        }
        // Fetch the existing bank account details for the supplier
        const { status, bankAccount, message } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$bankAccount$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSupplierBankAccountBySupplierId"])(supplierId);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Supplier payload for bank account change request:', supplierBankAccountPayload);
        // Create or update bank account change request
        const supplierBankAccountChangeRequestResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$bankAccount$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["requestSupplierBankAccountChange"])(supplierId, String(supplierRole), supplierBankAccountPayload);
        if (!supplierBankAccountChangeRequestResult.status) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Failed to create/update supplier bank account change request', supplierBankAccountChangeRequestResult?.message);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: supplierBankAccountChangeRequestResult?.message || 'Failed to create/update supplier bank account change request'
            }, {
                status: 500
            });
        }
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Error during supplier bank account change request process:', errorMessage);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: errorMessage
        }, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__4026a7f0._.js.map