...
"[project]/.next-internal/server/app/api/supplier/product/my-inventory/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
const getSupplierProductById = async (id, includeOtherSuppliers = false)=>{
    try {
        const supplierProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].supplierProduct.findFirst({
            where: {
                id
...
const getProductsByFiltersAndStatus = async (type, filters, dropshipperId, status)=>{
    try {
        ...
        if (type === "notmy") {
            ...
            const productsWithLowestPrice = await Promise.all(supplierProducts.map(async (sp)=>{
                const lowestPriceDropshipper = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].dropshipperProduct.findFirst({
                    where: {
...
"[project]/src/app/api/supplier/product/my-inventory/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const productsResult = categoryId || brandId ? await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProductsByFiltersAndStatus"])(type, filters, supplierId, status) : await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProductsByStatus"])(type, supplierId, status);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e00708f7._.js.map