...
"[project]/.next-internal/server/app/api/good-pincode/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/models/goodPincode.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "createGoodPincode": (()=>createGoodPincode),
    "deleteGoodPincode": (()=>deleteGoodPincode),
    "getAllGoodPincodes": (()=>getAllGoodPincodes),
    "getGoodPincodeById": (()=>getGoodPincodeById),
    "getGoodPincodeByPincode": (()=>getGoodPincodeByPincode),
    "getGoodPincodeByPincodeForUpdate": (()=>getGoodPincodeByPincodeForUpdate),
    "getGoodPincodesByStatus": (()=>getGoodPincodesByStatus),
    "restoreGoodPincode": (()=>restoreGoodPincode),
    "softDeleteGoodPincode": (()=>softDeleteGoodPincode),
    "updateGoodPincode": (()=>updateGoodPincode)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
;
...
async function createGoodPincode(adminId, adminRole, goodPincode) {
    try {
        const { pincode, status, createdBy, createdByRole } = goodPincode;
        const newGoodPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].goodPincode.create({
            data: {
                pincode,
                status,
                createdAt: new Date(),
        ...
        return {
            status: true,
            goodPincode: serializeBigInt(newGoodPincode)
        };
    } catch (error) {
...
const updateGoodPincode = async (adminId, adminRole, goodPincodeId, data)=>{
    try {
        const { pincode, status, updatedBy, updatedByRole } = data;
        const goodPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].goodPincode.update({
            where: {
                id: goodPincodeId
            },
            data: {
        ...
        return {
            status: true,
            goodPincode: serializeBigInt(goodPincode)
        };
    } catch (error) {
        console.error("❌ updateGoodPincode Error:", error);
        return {
            status: false,
            message: "Error updating goodPincode"
        };
    }
};
const getGoodPincodeById = async (id)=>{
    try {
        const goodPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].goodPincode.findUnique({
            where: {
                id
            }
        });
        if (!goodPincode) return {
            status: false,
            message: "GoodPincode not found"
        };
        return {
            status: true,
            goodPincode: serializeBigInt(goodPincode)
        ...
        return {
            status: false,
            message: "Error fetching goodPincode"
        };
    }
};
const getGoodPincodeByPincode = async (pincode)=>{
    try {
        const goodPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].goodPincode.findFirst({
            where: {
                pincode
            }
        });
...
const getGoodPincodeByPincodeForUpdate = async (pincode, goodPincodeId)=>{
    try {
        const goodPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].goodPincode.findFirst({
            where: {
                pincode,
...
const getAllGoodPincodes = async ()=>{
    try {
        const goodPincodes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].goodPincode.findMany({
            orderBy: {
                id: 'desc'
            }
        });
        return {
            status: true,
            goodPincodes: serializeBigInt(goodPincodes)
        };
    } catch (error) {
        console.error("❌ getAllGoodPincodes Error:", error);
        return {
            status: false,
            message: "Error fetching goodPincodes"
        };
    }
};
const getGoodPincodesByStatus = async (status)=>{
    try {
        let whereCondition = {};
        switch(status){
            case "active":
...
const softDeleteGoodPincode = async (adminId, adminRole, id)=>{
    try {
        const updatedGoodPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].goodPincode.update({
            where: {
                id
            },
            data: {
        ...
        return {
            status: true,
            message: "GoodPincode soft deleted successfully",
            updatedGoodPincode: serializeBigInt(updatedGoodPincode)
        };
    } catch (error) {
        console.error("❌ softDeleteGoodPincode Error:", error);
        return {
            status: false,
            message: "Error soft deleting goodPincode"
        };
    }
};
const restoreGoodPincode = async (adminId, adminRole, id)=>{
    try {
        const restoredGoodPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].goodPincode.update({
            where: {
                id
            },
            data: {
        ...
        return {
            status: true,
            message: "GoodPincode restored successfully",
            restoredGoodPincode: serializeBigInt(restoredGoodPincode)
        };
    } catch (error) {
        console.error("❌ restoreGoodPincode Error:", error);
        return {
            status: false,
            message: "Error restoring goodPincode"
        };
    }
};
const deleteGoodPincode = async (id)=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].goodPincode.delete({
            where: {
                id
            }
        });
        return {
            status: true,
            message: "GoodPincode deleted successfully"
        };
    } catch (error) {
        console.error("❌ deleteGoodPincode Error:", error);
        return {
            status: false,
            message: "Error deleting goodPincode"
        };
    }
};
}}),
"[project]/src/app/api/good-pincode/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$goodPincode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/goodPincode.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(req) {
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'POST request received for goodPincode creation');
        ...
        const getGoodPincodeByPincodeResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$goodPincode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGoodPincodeByPincode"])(pincode || '');
        if (!getGoodPincodeByPincodeResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'GoodPincode already exists:', getGoodPincodeByPincodeResult?.message || 'Unknown error');
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: getGoodPincodeByPincodeResult?.message || 'GoodPincode already exists'
            }, {
                status: 400
            });
        }
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'GoodPincode payload created:', goodPincodePayload);
        const goodPincodeCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$goodPincode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createGoodPincode"])(adminId, String(adminRole), goodPincodePayload);
        if (goodPincodeCreateResult?.status) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                goodPincode: goodPincodeCreateResult.goodPincode
            }, {
                status: 200
            });
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'GoodPincode creation failed:', goodPincodeCreateResult?.message || 'Unknown error');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: goodPincodeCreateResult?.message || 'GoodPincode creation failed'
        }, {
            status: 500
        });
    } catch (err) {
        const error = err instanceof Error ? err.message : 'Internal Server Error';
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'GoodPincode Creation Error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error
        }, {
...
async function GET(req) {
    try {
        ...
        const goodPincodesResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$goodPincode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getGoodPincodesByStatus"])('notDeleted');
        // Handle response based on goodPincodes result
        if (goodPincodesResult?.status) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                goodPincodes: goodPincodesResult.goodPincodes
            }, {
                status: 200
            });
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'No goodPincodes found'
        }, {
            status: 404
        });
    } catch (error) {
        // Log and handle any unexpected errors
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Error while fetching goodPincodes', {
            error
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Failed to fetch goodPincodes due to an internal error'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d3985245._.js.map