    ...
    try {
        ...
        for (const item of items){
            ...
            const [productExists, variantExists] = await Promise.all([
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$product$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProductById"])(productId),
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$product$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProductVariantById"])(variantId)
            ]);
        ...
        const placeOrderShippingResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$order$2f$placeOrderShipping$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["placeOrderShipping"])(orderCreateResult.order.id);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Order shipping created:', placeOrderShippingResult);
        if (!placeOrderShippingResult || !placeOrderShippingResult.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Order shipping creation failed:', placeOrderShippingResult?.message || 'Unknown error');
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: placeOrderShippingResult?.message || 'Order shipping creation failed'
            }, {
                status: 500
            });
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Order created successfully:', orderCreateResult.order);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: true,
            error: placeOrderShippingResult?.message || 'Order created Successfuly'
        }, {
            status: 200
        });
    } catch (err) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6a8f5dd3._.js.map