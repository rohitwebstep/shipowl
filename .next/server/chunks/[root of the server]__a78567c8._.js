...
"[project]/.next-internal/server/app/api/dropshipper/[dropshipperId]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "D:\\Webstep\\Shipping OWL\\2025\\April\\28\\WORKING\\shipping-owl\\prisma\\prisma\\generated\\client",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "D:\\Webstep\\Shipping OWL\\2025\\April\\28\\WORKING\\shipping-owl\\prisma\\schema.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    "inlineSchemaHash": "4f41249b8a5372819f35d24bcb34f70b520b53b70d266f80b7cb6c9501cd49c2",
    "copyEngine": true
};
...
async function checkEmailAvailability(email) {
    try {
        ...
        const existingDropshipper = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.findUnique({
            where: {
                email
            },
            select: {
...
async function createDropshipper(adminId, adminRole, dropshipper) {
    try {
        ...
        return {
            status: true,
            dropshipper: sanitizedDropshipper
        };
    } catch (error) {
        console.error(`Error creating city:`, error);
        return {
...
const getDropshippersByStatus = async (status = "notDeleted")=>{
    try {
        let whereCondition = {};
        switch(status){
            case "notDeleted":
...
const getDropshipperById = async (id)=>{
    try {
...
const updateDropshipper = async (adminId, adminRole, dropshipperId, dropshipper)=>{
    try {
        const { name, profilePicture, email, password, permanentAddress, permanentPostalCode, permanentCity, permanentState, permanentCountry, status: statusRaw, updatedAt, updatedBy, updatedByRole } = dropshipper;
        // Convert statusRaw to a boolean using the includes check
        const status = [
            'true',
            '1',
...
const restoreDropshipper = async (adminId, adminRole, id)=>{
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'fetched dropshippers :', sanitizedDropshipper);
        return {
            status: true,
...
"[project]/src/app/models/dropshipper/company.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "createDropshipperCompany": (()=>createDropshipperCompany),
    "getCompanyDeailByDropshipperId": (()=>getCompanyDeailByDropshipperId),
    "removeCompanyDetailImageByIndex": (()=>removeCompanyDetailImageByIndex),
    "updateDropshipperCompany": (()=>updateDropshipperCompany)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/path [external] (path, cjs)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$saveFiles$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/saveFiles.ts [app-route] (ecmascript)");
...
const getCompanyDeailByDropshipperId = async (dropshipperId)=>{
    try {
        ...
        return {
            status: false,
            message: "Error fetching dropshipper bank account"
        };
    }
};
async function createDropshipperCompany(adminId, adminRole, dropshipperCompany) {
    try {
        const { admin, gstNumber, gstDocument, panCardHolderName, aadharCardHolderName, panCardImage, aadharCardImage, createdAt, createdBy, createdByRole } = dropshipperCompany;
        const newDropshipper = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].companyDetail.create({
            data: {
                admin,
                gstNumber,
                gstDocument,
...
const removeCompanyDetailImageByIndex = async (companyDetailId, dropshipperId, imageType, imageIndex)=>{
    try {
...
async function updateDropshipperCompany(adminId, adminRole, dropshipperId, dropshipperCompany) {
    try {
        ...
        const updatedDropshipper = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].companyDetail.update({
            where: {
                adminId: dropshipperId
            },
            data: {
        ...
        return {
            status: true,
            dropshipper: serializeBigInt(updatedDropshipper)
        };
    } catch (error) {
...
"[project]/src/app/models/dropshipper/bankAccount.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "createDropshipperBankAccount": (()=>createDropshipperBankAccount),
    "getBankAccountById": (()=>getBankAccountById),
    "removeBankAccountImageByIndex": (()=>removeBankAccountImageByIndex),
    "updateDropshipperBankAccount": (()=>updateDropshipperBankAccount)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/commonUtils.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/path [external] (path, cjs)");
...
async function createDropshipperBankAccount(adminId, adminRole, payload) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])("error", "Error creating dropshipper bank account", error);
        return {
            status: false,
            message: "Internal Server Error"
        };
...
const removeBankAccountImageByIndex = async (bankAccountId, dropshipperId, imageType, imageIndex)=>{
    try {
...
async function updateDropshipperBankAccount(adminId, adminRole, dropshipperId, payload) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])("error", "Error updating/creating dropshipper bank account", error);
        return {
            status: false,
            message: "Internal Server Error"
        };
...
"[project]/src/app/api/dropshipper/[dropshipperId]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$company$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/dropshipper/company.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$bankAccount$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/dropshipper/bankAccount.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Requested Dropshipper ID:', dropshipperId);
        ...
        if (isNaN(dropshipperIdNum)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Invalid dropshipper ID', {
                dropshipperId
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid dropshipper ID'
            }, {
                status: 400
            });
        }
        ...
        if (dropshipperResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Dropshipper found:', dropshipperResult.dropshipper);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                dropshipper: dropshipperResult.dropshipper
            }, {
                status: 200
            });
        }
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '❌ Error fetching single dropshipper:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Server error'
        }, {
...
async function PUT(req) {
    try {
        ...
        const dropshipperResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$dropshipper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDropshipperById"])(dropshipperIdNum);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Dropshipper fetch result:', dropshipperResult);
        if (!dropshipperResult?.status) {
        ...
        const { status: checkEmailAvailabilityResult, message: checkEmailAvailabilityMessage } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$dropshipper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkEmailAvailabilityForUpdate"])(email, dropshipperIdNum);
        ...
        const dropshipperCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$dropshipper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateDropshipper"])(adminId, String(adminRole), dropshipperIdNum, dropshipperPayload);
        ...
        const companyUploadDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'uploads', 'dropshipper', `${dropshipperCreateResult.dropshipper.id}`, 'company');
        ...
        const dropshipperCompanyUploadedFiles = {};
        for (const field of dropshipperCompanyFileFields){
            ...
            if (fileData) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'uploaded fileData:', fileData);
                if (Array.isArray(fileData)) {
                    dropshipperCompanyUploadedFiles[field] = fileData.map((file)=>file.url).join(', ');
                } else {
                    dropshipperCompanyUploadedFiles[field] = fileData.url;
                }
            }
        }
        const dropshipperCompanyPayload = {
            admin: {
                connect: {
                    id: dropshipperCreateResult.dropshipper.id
                }
            },
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Dropshipper payload updated:', dropshipperCompanyPayload);
        const dropshipperCompanyCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$company$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateDropshipperCompany"])(adminId, String(adminRole), dropshipperIdNum, dropshipperCompanyPayload);
        if (!dropshipperCompanyCreateResult || !dropshipperCompanyCreateResult.status || !dropshipperCompanyCreateResult.dropshipper) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Dropshipper company creation failed', dropshipperCompanyCreateResult?.message);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: dropshipperCompanyCreateResult?.message || 'Dropshipper company creation failed'
            }, {
                status: 500
            });
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Dropshipper\'s bank accounts:', bankAccounts);
        ...
        const dropshipperBankAccountCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$bankAccount$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateDropshipperBankAccount"])(adminId, String(adminRole), dropshipperIdNum, dropshipperBankAccountPayload);
        if (!dropshipperBankAccountCreateResult || !dropshipperBankAccountCreateResult.status || !dropshipperBankAccountCreateResult.bankAccounts) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Dropshipper company creation failed', dropshipperBankAccountCreateResult?.message);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
...
async function PATCH(req) {
    try {
        ...
        const restoreResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$dropshipper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restoreDropshipper"])(adminId, String(adminRole), dropshipperIdNum);
        if (restoreResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Dropshipper restored successfully:', restoreResult.restoredDropshipper);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                dropshipper: restoreResult.restoredDropshipper
            }, {
                status: 200
            });
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Dropshipper restore failed');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Dropshipper restore failed'
        }, {
            status: 500
        });
    } catch (error) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '❌ Dropshipper restore error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Server error'
        }, {
...
async function DELETE(req) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$dropshipper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["softDeleteDropshipper"])(Number(adminId), String(adminRole), dropshipperIdNum); // Assuming softDeleteDropshipper marks the dropshipper as deleted
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `Soft delete request for dropshipper: ${dropshipperIdNum}`, {
            adminId
        });
        if (result?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `Dropshipper soft deleted successfully: ${dropshipperIdNum}`, {
                adminId
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `Dropshipper not found or could not be deleted: ${dropshipperIdNum}`, {
            adminId
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            message: 'Dropshipper not found or deletion failed'
        }, {
            status: 404
        });
    } catch (error) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Error during dropshipper deletion', {
            error
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a78567c8._.js.map