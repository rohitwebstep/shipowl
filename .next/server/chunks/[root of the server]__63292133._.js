 ...
 */ const config = {
    ...
    "inlineSchemaHash": "87ddbed88ea4143b09d2db5a361b4c8ba101e6f0905d0abbe4721fcee268c16a",
    "copyEngine": true
};
...
async function saveFilesFromFormData(formData, fieldName, options) {
    ...
    for(let index = 0; index < files.length; index++){
        ...
        const fileUrl = publicIndex !== -1 ? fullPath.split('public')[1].replace(/\\/g, '/') : fullPath;
        const info = {
