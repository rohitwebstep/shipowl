...
async function GET(req) {
    try {
        ...
        */ // ✅ Validate HMAC
        ...
        const generatedHash = __TURBOPACK__imported__module__$5b$externals$5d2f$crypto__$5b$external$5d$__$28$crypto$2c$__cjs$29$__["default"].createHmac('sha256', apiSecret).update(message).digest('hex');
        ...
        const shopInfoRes = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].get(`https://${shop}/admin/api/${apiVersion}/shop.json`, {
            headers: {
        ...
        if (result?.status) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                redirectUrl: shopifyAppRedirectUrl
            }, {
                status: 200
            });
        }
