...
"[project]/.next-internal/server/app/api/dropshipper/profile/update/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
const getCompanyDeailByDropshipperId = async (dropshipperId)=>{
    try {
        ...
        return {
            status: false,
            message: "Error fetching dropshipper Detail"
        };
    }
};
...
async function updateDropshipperCompany(adminId, adminRole, dropshipperId, dropshipperCompany) {
    try {
        ...
        const updatedOrCreated = currentCompanyDetail ? await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].companyDetail.update({
            where: {
                adminId: dropshipperId
            },
            data
        ...
        return {
            status: true,
            dropshipper: serializeBigInt(updatedOrCreated)
        };
    } catch (error) {
...
"[project]/src/app/api/dropshipper/profile/update/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function PUT(req) {
    try {
        ...
        const userCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$authUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isUserExist"])(dropshipperId, String(dropshipperRole));
        if (!userCheck.status) {
        ...
        const { status: checkEmailAvailabilityResult, message: checkEmailAvailabilityMessage } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$dropshipper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkEmailAvailabilityForUpdate"])(email, dropshipperId);
        ...
        const dropshipperCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$dropshipper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateDropshipper"])(dropshipperId, String(dropshipperRole), dropshipperId, dropshipperPayload);
        ...
        const dropshipperCompanyCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$company$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateDropshipperCompany"])(dropshipperId, String(dropshipperRole), dropshipperId, dropshipperCompanyPayload);
        ...
        const dropshipperBankAccountCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$bankAccount$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateDropshipperBankAccount"])(dropshipperId, String(dropshipperRole), dropshipperId, dropshipperBankAccountPayload);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__17f46f80._.js.map