...
async function assignProductVisibilityToSuppliers(adminId, adminRole, productId, supplierIds) {
    try {
        ...
        // Fetch existing visibility entries for the product
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].$transaction(async (tx)=>{
            // Update product to set isVisibleToAll to false
            ...
            // Create new visibility entries for new supplier IDs
        ...
        // Fetch updated visibility entries for response
        ...
        return {
            status: true,
            message: `Product visibility assigned to ${supplierIds.length} supplier(s) successfully.`,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__6b7a44e8._.js.map