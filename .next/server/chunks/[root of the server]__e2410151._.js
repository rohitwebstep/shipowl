 ...
 */ const config = {
    ...
    "inlineSchemaHash": "2c2ba1444605a2538ce9272c21328d206e8b7553aff2c755e93d6d0523f35fa1",
    "copyEngine": true
};
...
__turbopack_context__.s({
    ...
    "updateBarcodeOfOrder": (()=>updateBarcodeOfOrder),
...
const updateBarcodeOfOrder = async (orderId, barcodeImage)=>{
    try {
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.update({
            where: {
                id: orderId
        ...
        return {
            status: false,
            message: "Error updating order barcode"
        };
    }
};
...
async function POST(req) {
    try {
        ...
        try {
            ...
            const barcodeDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].dirname(barcodePath);
            await __TURBOPACK__imported__module__$5b$externals$5d2f$fs$2f$promises__$5b$external$5d$__$28$fs$2f$promises$2c$__cjs$29$__["default"].mkdir(barcodeDir, {
                recursive: true
            });
            // Generate barcode
        ...
        const updateBarcodeOfOrderResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateBarcodeOfOrder"])(order.id, barcodePublicPath);
        if (!updateBarcodeOfOrderResult || !updateBarcodeOfOrderResult.status || !updateBarcodeOfOrderResult.order) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Order barcode updation failed:', updateBarcodeOfOrderResult?.message || 'Unknown error');
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: updateBarcodeOfOrderResult?.message || 'Order barcode updation failed'
            }, {
                status: 500
            });
        }
        ...
        for (const item of items){
            ...
            const [productExists, variantExists] = await Promise.all([
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDropshipperProductById"])(dropshipperProductId),
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDropshipperProductVariantById"])(dropshipperProductVariantId)
            ]);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e2410151._.js.map