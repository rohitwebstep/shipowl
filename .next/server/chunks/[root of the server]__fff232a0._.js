...
"[project]/.next-internal/server/app/api/supplier/order/[orderId]/rto/[orderItemId]/response/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "a915bc72148650b0cd71e7cefd7d372eb89f06591d6324e7a295aefafa9a54fb",
    "copyEngine": true
};
...
__turbopack_context__.s({
    ...
    "updateOrderItemRTOInfo": (()=>updateOrderItemRTOInfo)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
;
...
async function getOrderItem(orderId, orderItemId) {
    try {
        const orderItem = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].orderItem.findUnique({
            where: {
                id: orderItemId
            }
        });
        ...
        if (orderItem.orderId !== orderId) {
            return {
                status: false,
                message: "Order ID does not match with the order item"
            };
        }
        return {
            status: true,
...
async function updateOrderItemRTOInfo({ orderId, orderItemId, status, uploadedMedia = {} }) {
    ...
    try {
        ...
        if (status.toLowerCase() === 'wrong item received') {
            ...
            if (!Array.isArray(packingGallery) || packingGallery.length === 0 || !Array.isArray(unboxingGallery) || unboxingGallery.length === 0) {
                return {
                    status: false,
        ...
        const updatedOrderItem = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].orderItem.update({
            where: {
                id: orderItemId
            },
            data: updateData
        ...
        return {
            status: true,
            message: "Order item RTO info updated successfully.",
...
"[project]/src/app/api/supplier/order/[orderId]/rto/[orderItemId]/response/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (!supplierIdHeader || isNaN(supplierId)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', `Invalid or missing supplier ID: ${supplierIdHeader}`);
        ...
        const orderItemResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$item$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrderItem"])(orderId, orderItemId);
        ...
        if (!orderItemResult.status || !orderItemResult.orderItem) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', `Order item not found or does not belong to order. Order Item ID: ${orderItemId}`);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                message: 'Order item not found or does not belong to the specified order.'
            }, {
                status: 404
            });
        }
        ...
        if (order.rtoDelivered && order.rtoDeliveredDate) {
            ...
            if (now - rtoDeliveredTime > ONE_DAY_MS) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', `Dispute period expired for order item ID: ${orderItemId}`);
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    status: false,
                    message: 'Dispute period of 24 hours has expired; you cannot dispute now.'
                }, {
                    status: 400
                });
            }
        ...
        if (orderItem.supplierRTOResponse) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', `RTO response already submitted for order item ID: ${orderItemId}`);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                message: 'RTO response has already been submitted for this order item.'
            }, {
                status: 409
            } // Conflict
            );
        ...
        if (status.toLowerCase() === 'wrong item received') {
            ...
            const packingFiles = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$saveFiles$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["saveFilesFromFormData"])(formData, 'packingGallery', {
                dir: __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'uploads', 'returns'),
                pattern: 'slug-unique',
                multiple: true
            });
            ...
            if (!Array.isArray(packingFiles) || !Array.isArray(unboxingFiles) || packingFiles.length === 0 || unboxingFiles.length === 0) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$item$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateOrderItemRTOInfo"])(orderItemRTOPayload);
        if (!result.status) {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `Order item status updated successfully for orderItemId: ${orderItemId}`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: true,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', `Error updating order item status: ${errorMessage}`);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__fff232a0._.js.map