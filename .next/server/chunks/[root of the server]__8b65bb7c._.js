...
async function handleForgetPassword(req, adminRole, adminStaffRole) {
    try {
        ...
        const resetUrl = `https://yourdomain.com/reset-password?token=${token}&email=${encodeURIComponent(email)}`;
        const mailData = {
            recipient: [
                {
                    name: admin.name,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8b65bb7c._.js.map