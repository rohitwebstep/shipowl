...
"[project]/.next-internal/server/app/api/dropshipper/shopify/[shopifyStoreId]/orders/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/utils/order/fetchShopifyStoreOrders.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "fetchShopifyStoreOrders": (()=>fetchShopifyStoreOrders)
});
...
async function fetchShopifyStoreOrders(shop, access_token) {
    if (!shop || !access_token) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Missing shop or access token', {
            shop
        });
        return {
            status: false,
    ...
    try {
        ...
        if (response.data.errors) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Shopify GraphQL errors', response.data.errors);
            return {
                status: false,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Fetch orders error', {
            error
        });
        return {
            status: false,
...
"[project]/src/app/api/dropshipper/shopify/[shopifyStoreId]/orders/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$order$2f$fetchShopifyStoreOrders$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/order/fetchShopifyStoreOrders.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req) {
    try {
        ...
        if (isNaN(shopifyStoreId)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Invalid Shopify store ID format', {
                shopifyStoreId
            });
        ...
        if (!dropshipperId || isNaN(dropshipperId)) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: 'Missing or invalid dropshipper ID'
            }, {
                status: 400
            });
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Dropshipper headers received', {
            dropshipperId,
            dropshipperRole
        });
        // User validation
        ...
        if (!shopifyStore.shop || !shopifyStore.accessToken) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: 'Missing shop or access token in Shopify store data'
            }, {
                status: 400
            });
        }
        // Fetch orders from Shopify
        const ordersResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$order$2f$fetchShopifyStoreOrders$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["fetchShopifyStoreOrders"])(shopifyStore.shop, shopifyStore.accessToken);
        ...
        const storesResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$shopify$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getShopifyStoresByDropshipperId"])(mainDropshipperId);
        if (!storesResult.status) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: 'Unable to retrieve Shopify stores for this dropshipper'
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__c6b1f5bd._.js.map