...
async function POST(req) {
    try {
        ...
        const productCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$product$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createProduct"])(supplierId, String(supplierRole), productPayload);
        if (productCreateResult?.status) {
            if (!isVisibleToAll && supplierIds.length > 0) {
                if (productCreateResult.status && productCreateResult.product) {
                    const visibilityResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$product$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assignProductVisibilityToSuppliers"])(supplierId, String(supplierRole), productCreateResult.product.id, supplierIds);
                    if (visibilityResult.status) {
                        ...
                        const parsedVariants = productCreateResult.product.variants.map((variant)=>({
                                ...
                                stock: variant.qty,
                                price: variant.shipowl_price,
                                status: true // or add logic like variant.qty > 0
                            }));
                        const productPayload = {
                        ...
                        const supplierProductResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSupplierProduct"])(supplierId, String(supplierRole), productPayload);
                        if (supplierProductResult?.status) {
                            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                                status: true,
                                product: supplierProductResult.product
                            }, {
                                status: 200
                            });
                        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__5ae17d7e._.js.map