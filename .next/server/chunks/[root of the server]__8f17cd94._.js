...
"[project]/.next-internal/server/app/api/dropshipper/profile/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/dropshipper/profile/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        if (!dropshipperId || isNaN(Number(dropshipperId))) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Invalid or missing dropshipper ID', {
                dropshipperId
            });
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', `Requested Dropshipper ID: ${dropshipperId}, Role: ${dropshipperRole}`);
        const userCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$authUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isUserExist"])(Number(dropshipperId), String(dropshipperRole));
        if (!userCheck.status) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8f17cd94._.js.map