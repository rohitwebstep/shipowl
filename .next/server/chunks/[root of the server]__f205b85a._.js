...
"[project]/.next-internal/server/app/api/order/[orderId]/shipping/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/prisma/prisma/generated/client/runtime/library.js [app-route] (ecmascript)": (function(__turbopack_context__) {
...
const { PrismaClientKnownRequestError, PrismaClientUnknownRequestError, PrismaClientRustPanicError, PrismaClientInitializationError, PrismaClientValidationError, getPrismaClient, sqltag, empty, join, raw, skip, Decimal, Debug, objectEnumValues, makeStrictEnum, Extensions, warnOnce, defineDmmfProperty, Public, getRuntime, createParam } = __turbopack_context__.r("[project]/prisma/prisma/generated/client/runtime/library.js [app-route] (ecmascript)");
const Prisma = {};
...
var __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2f$generated$2f$client$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/prisma/prisma/generated/client/index.js [app-route] (ecmascript)"); // Adjust the import path as necessary
;
const prisma = new __TURBOPACK__imported__module__$5b$project$5d2f$prisma$2f$prisma$2f$generated$2f$client$2f$index$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["PrismaClient"]();
...
__turbopack_context__.s({
    ...
    "updateShippingApiResultOfOrder": (()=>updateShippingApiResultOfOrder)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
;
...
async function generateOrderNumber(base = '') {
    const cleanBase = base ? base.toUpperCase().replace(/[^A-Z0-9]/g, '') : Array.from({
        length: 8
    ...
    let suffix = 0;
    while(isTaken){
        const existingOrder = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.findUnique({
            where: {
                orderNumber
            }
        });
...
async function createOrder(order) {
    try {
        ...
        const { status, orderNote, subtotal, tax, discount, totalAmount, currency, shippingName, shippingPhone, shippingEmail, shippingAddress, shippingZip, shippingCountry, shippingState, shippingCity, billingName, billingPhone, billingEmail, billingAddress, billingZip, billingCountry, billingState, billingCity, payment } = order;
...
const updateShippingApiResultOfOrder = async (adminId, adminRole, orderId, data)=>{
    try {
        const { updatedBy, updatedByRole, shippingApiJson } = data;
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.update({
            where: {
                id: orderId
            },
...
"[project]/src/utils/order/placeOrderShipping.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "placeOrderShipping": (()=>placeOrderShipping)
});
...
;
;
async function placeOrderShipping(orderId) {
    try {
        ...
        const products = await Promise.all(order.items.map(async (item)=>{
            const productRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$product$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProductById"])(item.productId ?? 0);
            const product = productRes?.product;
            const variantRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$product$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProductVariantById"])(item.variantId ?? 0);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])(`debug`, `shippingPayload:`, shippingPayload);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])("debug", "shipping result:", result);
        if (result?.status) {
...
"[project]/src/app/models/highRto.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "createHighRto": (()=>createHighRto),
    "deleteHighRto": (()=>deleteHighRto),
    "getAllHighRtos": (()=>getAllHighRtos),
    "getHighRtoById": (()=>getHighRtoById),
    "getHighRtoByPincode": (()=>getHighRtoByPincode),
    "getHighRtoByPincodeForUpdate": (()=>getHighRtoByPincodeForUpdate),
    "getHighRtosByStatus": (()=>getHighRtosByStatus),
    "restoreHighRto": (()=>restoreHighRto),
    "softDeleteHighRto": (()=>softDeleteHighRto),
    "updateHighRto": (()=>updateHighRto)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
;
const serializeBigInt = (obj)=>{
...
async function createHighRto(adminId, adminRole, highRto) {
    try {
        const { pincode, city, state, country, status, createdBy, createdByRole } = highRto;
        const newHighRto = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].highRto.create({
            data: {
                pincode,
                city,
                state,
        ...
        return {
            status: true,
            highRto: serializeBigInt(newHighRto)
        };
    } catch (error) {
...
const updateHighRto = async (adminId, adminRole, highRtoId, data)=>{
    try {
        const { pincode, city, state, country, status, updatedBy, updatedByRole } = data;
        const highRto = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].highRto.update({
            where: {
                id: highRtoId
            },
            data: {
        ...
        return {
            status: true,
            highRto: serializeBigInt(highRto)
        };
    } catch (error) {
        console.error("❌ updateHighRto Error:", error);
        return {
            status: false,
            message: "Error updating highRto"
        };
    }
};
const getHighRtoById = async (id)=>{
    try {
        const highRto = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].highRto.findUnique({
            where: {
                id
            }
        });
        ...
        return {
            status: false,
            message: "Error fetching highRto"
        };
    }
};
const getHighRtoByPincode = async (pincode)=>{
    try {
        const highRto = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].highRto.findFirst({
            where: {
                pincode
            }
        });
...
const getHighRtoByPincodeForUpdate = async (pincode, highRtoId)=>{
    try {
        const highRto = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].highRto.findFirst({
            where: {
                pincode,
...
const getAllHighRtos = async ()=>{
    try {
        const highRtos = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].highRto.findMany({
            orderBy: {
                id: 'desc'
            }
        });
        return {
            status: true,
            highRtos: serializeBigInt(highRtos)
        };
    } catch (error) {
        console.error("❌ getAllHighRtos Error:", error);
        return {
            status: false,
            message: "Error fetching highRtos"
        };
    }
};
const getHighRtosByStatus = async (status)=>{
    try {
        let whereCondition = {};
        switch(status){
            case "active":
...
const softDeleteHighRto = async (adminId, adminRole, id)=>{
    try {
        const updatedHighRto = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].highRto.update({
            where: {
                id
            },
            data: {
        ...
        return {
            status: true,
            message: "HighRto soft deleted successfully",
            updatedHighRto: serializeBigInt(updatedHighRto)
        };
    } catch (error) {
        console.error("❌ softDeleteHighRto Error:", error);
        return {
            status: false,
            message: "Error soft deleting highRto"
        };
    }
};
const restoreHighRto = async (adminId, adminRole, id)=>{
    try {
        const restoredHighRto = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].highRto.update({
            where: {
                id
            },
            data: {
        ...
        return {
            status: true,
            message: "HighRto restored successfully",
            restoredHighRto: serializeBigInt(restoredHighRto)
        };
    } catch (error) {
        console.error("❌ restoreHighRto Error:", error);
        return {
            status: false,
            message: "Error restoring highRto"
        };
    }
};
const deleteHighRto = async (id)=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].highRto.delete({
            where: {
                id
            }
        });
        return {
            status: true,
            message: "HighRto deleted successfully"
        };
    } catch (error) {
        console.error("❌ deleteHighRto Error:", error);
        return {
            status: false,
            message: "Error deleting highRto"
        };
    }
};
}}),
"[project]/src/app/models/badPincode.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "createBadPincode": (()=>createBadPincode),
    "deleteBadPincode": (()=>deleteBadPincode),
    "getAllBadPincodes": (()=>getAllBadPincodes),
    "getBadPincodeById": (()=>getBadPincodeById),
    "getBadPincodeByPincode": (()=>getBadPincodeByPincode),
    "getBadPincodeByPincodeForUpdate": (()=>getBadPincodeByPincodeForUpdate),
    "getBadPincodesByStatus": (()=>getBadPincodesByStatus),
    "importBadPincodes": (()=>importBadPincodes),
    "restoreBadPincode": (()=>restoreBadPincode),
    "softDeleteBadPincode": (()=>softDeleteBadPincode),
    "updateBadPincode": (()=>updateBadPincode)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
;
const serializeBigInt = (obj)=>{
...
async function createBadPincode(adminId, adminRole, badPincode) {
    try {
        const { pincode, status, createdBy, createdByRole } = badPincode;
        const newBadPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].badPincode.create({
            data: {
                pincode,
                status,
                createdAt: new Date(),
        ...
        return {
            status: true,
            badPincode: serializeBigInt(newBadPincode)
        };
    } catch (error) {
...
async function importBadPincodes(adminId, adminRole, badPincodes) {
    try {
        ...
        if (validBadPincodes.length === 0) {
            return {
                status: false,
                message: 'No valid pincodes to import.'
            };
        }
        // Check which pincodes already exist in the database
        const existingPincodes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].badPincode.findMany({
            where: {
                pincode: {
        ...
        if (newBadPincodes.length === 0) {
            return {
                status: false,
                message: 'All pincodes already exist in the database.'
            };
        }
        ...
        const result = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].badPincode.createMany({
            data: badPincodeData
        });
        // Return the result
        return {
            status: true,
            message: `${result.count} pincodes imported successfully.`
        };
    } catch (error) {
...
const updateBadPincode = async (adminId, adminRole, badPincodeId, data)=>{
    try {
        const { pincode, status, updatedBy, updatedByRole } = data;
        const badPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].badPincode.update({
            where: {
                id: badPincodeId
            },
            data: {
        ...
        return {
            status: true,
            badPincode: serializeBigInt(badPincode)
        };
    } catch (error) {
        console.error("❌ updateBadPincode Error:", error);
        return {
            status: false,
            message: "Error updating badPincode"
        };
    }
};
const getBadPincodeById = async (id)=>{
    try {
        const badPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].badPincode.findUnique({
            where: {
                id
            }
        });
        if (!badPincode) return {
            status: false,
            message: "BadPincode not found"
        };
        return {
            status: true,
            badPincode: serializeBigInt(badPincode)
        ...
        return {
            status: false,
            message: "Error fetching badPincode"
        };
    }
};
const getBadPincodeByPincode = async (pincode)=>{
    try {
        const badPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].badPincode.findFirst({
            where: {
                pincode
            }
        });
...
const getBadPincodeByPincodeForUpdate = async (pincode, badPincodeId)=>{
    try {
        const badPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].badPincode.findFirst({
            where: {
                pincode,
...
const getAllBadPincodes = async ()=>{
    try {
        const badPincodes = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].badPincode.findMany({
            orderBy: {
                id: 'desc'
            }
        });
        return {
            status: true,
            badPincodes: serializeBigInt(badPincodes)
        };
    } catch (error) {
        console.error("❌ getAllBadPincodes Error:", error);
        return {
            status: false,
            message: "Error fetching badPincodes"
        };
    }
};
const getBadPincodesByStatus = async (status)=>{
    try {
        let whereCondition = {};
        switch(status){
            case "active":
...
const softDeleteBadPincode = async (adminId, adminRole, id)=>{
    try {
        const updatedBadPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].badPincode.update({
            where: {
                id
            },
            data: {
        ...
        return {
            status: true,
            message: "BadPincode soft deleted successfully",
            updatedBadPincode: serializeBigInt(updatedBadPincode)
        };
    } catch (error) {
        console.error("❌ softDeleteBadPincode Error:", error);
        return {
            status: false,
            message: "Error soft deleting badPincode"
        };
    }
};
const restoreBadPincode = async (adminId, adminRole, id)=>{
    try {
        const restoredBadPincode = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].badPincode.update({
            where: {
                id
            },
            data: {
        ...
        return {
            status: true,
            message: "BadPincode restored successfully",
            restoredBadPincode: serializeBigInt(restoredBadPincode)
        };
    } catch (error) {
        console.error("❌ restoreBadPincode Error:", error);
        return {
            status: false,
            message: "Error restoring badPincode"
        };
    }
};
const deleteBadPincode = async (id)=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].badPincode.delete({
            where: {
                id
            }
        });
        return {
            status: true,
            message: "BadPincode deleted successfully"
        };
    } catch (error) {
        console.error("❌ deleteBadPincode Error:", error);
        return {
            status: false,
            message: "Error deleting badPincode"
        };
    }
};
}}),
"[project]/src/app/api/order/[orderId]/shipping/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/order/order.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$order$2f$placeOrderShipping$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/order/placeOrderShipping.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$highRto$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/highRto.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$badPincode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/badPincode.ts [app-route] (ecmascript)");
;
;
;
;
...
async function POST(req) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Requested OrderId ID:', orderIdId);
        // Get headers
        ...
        if (isNaN(orderIdIdNum)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Invalid orderId ID', {
                orderIdId
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid orderId ID'
            }, {
                status: 400
            });
        }
        const orderIdResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrderById"])(orderIdIdNum);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'OrderId fetch result:', orderIdResult);
        if (!orderIdResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'OrderId not found', {
                orderIdIdNum
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
        ...
        const getBadPincodeByPincodeResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$badPincode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBadPincodeByPincode"])(orderIdResult?.order?.shippingZip || '');
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Bad Pincode by Pincode result:', getBadPincodeByPincodeResult);
        if (getBadPincodeByPincodeResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Bad Pincode found:', getBadPincodeByPincodeResult);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
        ...
        const getHighRtoByPincodeResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$highRto$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getHighRtoByPincode"])(orderIdResult?.order?.shippingZip || '');
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'High RTO by Pincode result:', getHighRtoByPincodeResult);
        if (getHighRtoByPincodeResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'High RTO Pincode found:', getHighRtoByPincodeResult);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
        ...
        const placeOrderShippingResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$order$2f$placeOrderShipping$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["placeOrderShipping"])(orderIdIdNum);
        const orderPayload = {
            updatedBy: adminId,
            updatedByRole: adminRole || '',
        ...
        const updateShippingApiResultOfOrderResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateShippingApiResultOfOrder"])(adminId, String(adminRole), orderIdIdNum, orderPayload);
        if (!updateShippingApiResultOfOrderResult || !updateShippingApiResultOfOrderResult.status || !updateShippingApiResultOfOrderResult.order) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Failed to update order shipping API result:', updateShippingApiResultOfOrderResult);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '❌ OrderId Updation Error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error
        }, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__f205b85a._.js.map