 ...
 */ const config = {
    ...
    "inlineSchemaHash": "401c3198a7cb512dffeb439ad4f65d006eb4e845809704eabeaf746310af4c12",
    "copyEngine": true
};
...
const getOrdersByStatusForReporting = async (status)=>{
    try {
        let whereCondition = {};
        switch(status){
            case "active":
...
async function GET(req) {
    try {
        ...
        const ordersResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrdersByStatusForReporting"])('completedOrRto');
        ...
        orders.forEach((order)=>{
            ...
            orderItems.forEach((item)=>{
                ...
                const { variant: productVariant } = dropshipperVariant.supplierProductVariant;
                const productModal = productVariant?.modal;
                console.log('Product Modal:', productModal);
                if (productModal?.toLowerCase() === 'shipowl') {
                    console.log('✅ Product is using ShipOwl modal.');
                }
            });
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8a38b3b4._.js.map