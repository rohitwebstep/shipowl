...
"[project]/.next-internal/server/app/api/dropshipper/product/rto/inventory/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/models/dropshipper/rtoInventory.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "getRTOInventories": (()=>getRTOInventories)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
...
const getRTOInventories = async (dropshipperId)=>{
    try {
        const inventories = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].rtoInventory.findMany({
            where: {
                dropshipperId
            },
            orderBy: {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'RTO inventories fetched successfully', {
            dropshipperId
        });
        return {
            status: true,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Error fetching RTO inventories', {
            error,
            dropshipperId
        });
        return {
...
"[project]/src/app/api/dropshipper/product/rto/inventory/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$rtoInventory$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/dropshipper/rtoInventory.ts [app-route] (ecmascript)"); // <-- make sure this function exists
;
;
;
;
async function GET(req) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Received dropshipper info for RTO fetch', {
            dropshipperId,
            dropshipperRole
        });
        ...
        if (!userCheck.status) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: `Unauthorized: ${userCheck.message}`
            }, {
                status: 401
            });
        }
        // Fetch RTO Inventory
        const inventoryResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$rtoInventory$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getRTOInventories"])(dropshipperId);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'No RTO inventory found.'
        }, {
            status: 404
        });
    } catch (error) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Failed to fetch RTO inventory', {
            error
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Internal server error while fetching RTO inventory.'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__696ed8a4._.js.map