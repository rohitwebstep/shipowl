...
"[project]/.next-internal/server/app/api/admin/staff/[adminStaffId]/restore/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/admin/staff/[adminStaffId]/restore/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function PATCH(req) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Delete Admin Request:', {
            adminStaffId
        });
        // Get headers
        ...
        const userCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$authUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isUserExist"])(adminIdHeaderNum, String(adminRole));
        if (!userCheck.status) {
        ...
        const restoreResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$staff$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restoreAdminStaff"])(adminIdHeaderNum, String(adminRole), Number(adminStaffId));
        if (restoreResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Admin restored successfully:', restoreResult.restoredAdminStaff);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                admin: restoreResult.restoredAdminStaff,
                message: 'Admin Staff restored successfully'
            }, {
                status: 200
            });
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__3e1dba74._.js.map