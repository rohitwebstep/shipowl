 ...
 */ const config = {
    ...
    "inlineSchemaHash": "17cdd2801dfffe642c99d454ee040bd428773152b64a0f9bdb9ab95de4c4a608",
    "copyEngine": true
};
...
const getOrdersByStatusForReporting = async (status, fromDate, toDate)=>{
    try {
        let whereCondition = {};
        // Base filters based on status
        switch(status){
            case "active":
                whereCondition = {
                    status: true,
        ...
        // Add date filtering only if both fromDate and toDate are provided and valid
...
async function GET(req) {
    try {
        ...
        // Fetch orders
        const ordersResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrdersByStatusForReporting"])('completedOrRto', fromDate, toDate);
        ...
        orders.forEach((order)=>{
            ...
            orderItems.forEach((item)=>{
                ...
                if (productModal.toLowerCase() === 'shipowl') {
                    hasShipOwlProduct = true;
                    const totalShippingCost = orderItemQty * (Number(shippingCost) || 0);
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ded79710._.js.map