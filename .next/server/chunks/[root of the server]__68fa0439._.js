...
__turbopack_context__.s({
    ...
    "updateSupplierVerifyStatus": (()=>updateSupplierVerifyStatus)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/path [external] (path, cjs)");
...
const updateSupplierVerifyStatus = async (adminId, adminRole, supplierId, statusRaw)=>{
    try {
        // Convert status to a boolean using the includes check
        const status = [
            'true',
...
async function POST(req) {
    ...
    */ const { status: emailStatus, message: emailMessage, emailConfig, htmlTemplate, subject: emailSubject } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$emailConfig$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getEmailConfig"])('supplier', 'auth', 'registration', true);
        ...
        const token = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2f$authUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["generateRegistrationToken"])(supplierCreateResult.supplier.id, 'supplier');
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__68fa0439._.js.map