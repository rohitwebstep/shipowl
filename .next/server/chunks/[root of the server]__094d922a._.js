...
async function POST(req) {
    try {
        ...
        // File upload
        const uploadDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'tmp', 'uploads', 'category');
...
async function GET(req) {
    try {
        ...
        // Check if admin exists
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2f$authUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isUserExist"])(adminId, String(adminRole));
        if (!result.status) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__094d922a._.js.map