...
"[project]/.next-internal/server/app/api/admin/supplier/[supplierId]/payment-report/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
__turbopack_context__.s({
    ...
    "getOrdersByStatusForDropshipperReporting": (()=>getOrdersByStatusForDropshipperReporting),
    "getOrdersByStatusForSupplierReporting": (()=>getOrdersByStatusForSupplierReporting),
...
const getOrdersByStatusForDropshipperReporting = async (status, dropshipperId, fromDate, toDate)=>{
    try {
...
const getOrdersByStatusForSupplierReporting = async (status, supplierId, fromDate, toDate)=>{
    try {
        const whereCondition = {};
        // Apply base conditions
        if (status === "active") {
...
"[project]/src/app/api/admin/supplier/[supplierId]/payment-report/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Supplier ID extracted from path', {
            supplierId
        });
        const adminIdHeader = req.headers.get('x-admin-id');
        const adminRole = req.headers.get('x-admin-role');
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Admin headers received', {
            adminIdHeader,
            adminRole
        });
        const adminId = Number(adminIdHeader);
        if (!adminIdHeader || isNaN(adminId)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Invalid admin ID', {
                adminIdHeader
            });
        ...
        const supplier = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$supplier$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSupplierById"])(supplierId);
        if (!supplier?.status) {
        ...
        const parseDate = (value, outputFormat)=>{
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Failed to parse date', {
                value
            });
            return null;
        };
        ...
        const ordersResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrdersByStatusForSupplierReporting"])('completedOrRto', supplierId, fromDate, toDate);
        ...
        const configResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$app$2f$appConfig$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAppConfig"])();
        ...
        for (const order of orders){
            ...
            const orderType = isPostpaid ? 'postpaid' : 'prepaid';
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Internal error occurred', {
            error
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9c05ba51._.js.map