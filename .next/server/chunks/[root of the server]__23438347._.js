...
async function createPayment(adminId, adminRole, payment) {
    try {
        const { transactionId, cycle, amount, status, createdBy, createdByRole } = payment;
...
const updatePayment = async (adminId, adminRole, paymentId, data)=>{
    try {
        const { transactionId, cycle, amount, status, updatedBy, updatedByRole } = data;
