...
"[project]/.next-internal/server/app/api/bad-pincode/import/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "55e539c0a7ff6bdc140b00f8b4367c2ebe47b193d741ca5403ffb76ef1b9d716",
    "copyEngine": true
};
...
"[project]/src/utils/parseCsvExcel.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "parseFilesFromFormData": (()=>parseFilesFromFormData)
});
 ...
 */ async function parseCSVFile(file) {
    ...
    const result = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$papaparse$2f$papaparse$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parse"])(text, {
        header: true,
        skipEmptyLines: true
    });
    return {
 ...
 */ async function parseExcelFile(file) {
    ...
    const workbook = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["read"])(arrayBuffer, {
        type: 'array'
    });
    ...
    const headers = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$xlsx$2f$xlsx$2e$mjs__$5b$app$2d$route$5d$__$28$ecmascript$29$__["utils"].sheet_to_json(sheet, {
        header: 1
    })[0];
    return {
        headers: headers || [],
...
async function parseFilesFromFormData(formData, fieldName, options = {}) {
...
"[project]/src/app/api/bad-pincode/import/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$parseCsvExcel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/parseCsvExcel.ts [app-route] (ecmascript)");
...
async function POST(req) {
    try {
        ...
        const parsed = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$parseCsvExcel$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["parseFilesFromFormData"])(formData, 'badPincodes', {
            returnInArray: false,
            multiple: false
        });
        if (typeof parsed === 'object' && !Array.isArray(parsed) && 'rows' in parsed) {
            ...
            const filtered = parsed.rows.map((row)=>{
                const newRow = {};
            ...
            if (!filtered) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'File parsing failed');
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    status: false,
            ...
            const importBadPincodesResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$badPincode$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["importBadPincodes"])(adminId, String(adminRole), filteredWithPincodes);
            if (importBadPincodesResult?.status) {
                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                    status: true,
                    message: importBadPincodesResult?.message
                }, {
                    status: 200
                });
            }
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'BadPincode creation failed:', importBadPincodesResult?.message || 'Unknown error');
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: importBadPincodesResult?.message || 'BadPincode creation failed'
            }, {
                status: 500
            });
        } else {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__e386a24f._.js.map