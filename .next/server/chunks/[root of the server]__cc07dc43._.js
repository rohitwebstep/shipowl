...
"[project]/.next-internal/server/app/api/admin/staff/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/admin/staff/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const { status: checkEmailAvailabilityResult, message: checkEmailAvailabilityMessage } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$staff$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkEmailAvailability"])(email);
        ...
        const adminStaffCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$staff$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createAdminStaff"])(adminId, String(adminRole), adminPayload);
...
async function GET(req) {
    try {
        ...
        // Fetch all admins
        const adminsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$staff$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAdminStaffsByStatus"])("notDeleted");
        if (adminsResult?.status) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                admins: adminsResult.adminStaffs
            }, {
                status: 200
            });
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__cc07dc43._.js.map