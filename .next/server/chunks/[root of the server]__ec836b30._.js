...
async function POST(req) {
    try {
        ...
        const uploadPath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'uploads', 'products');
        ...
        const productData = {
            ...
            status: typeof status === 'string' ? [
                'true',
                '1'
            ].includes(status.toLowerCase()) : !!status,
            image
        };
        console.log(`productData - `, productData);
        await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$api$2f$models$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createProduct"])(Number(adminId), productData);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            success: true,
            files: fileData
        });
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ec836b30._.js.map