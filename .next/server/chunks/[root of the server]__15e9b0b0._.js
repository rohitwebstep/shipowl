...
"[project]/.next-internal/server/app/api/location/country/[countryId]/states/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
__turbopack_context__.s({
    ...
    "isStateInCountry": (()=>isStateInCountry),
...
const isStateInCountry = async (stateId, countryId)=>{
    try {
        const state = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].state.findUnique({
            where: {
                id: stateId
        ...
        if (state.countryId.toString() === countryId.toString()) {
            return {
                status: true,
                message: "State belongs to the specified country"
            };
        } else {
            return {
                status: false,
        ...
        return {
            status: false,
            message: "Error checking state-country relationship"
        };
    }
};
...
const getStatesByCountry = async (country, status = "notDeleted")=>{
    try {
...
"[project]/src/app/api/location/country/[countryId]/states/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        if (isNaN(countryIdNum)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Invalid country ID', {
                countryId
            });
        ...
        const countryResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$location$2f$country$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCountryById"])(countryIdNum);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Country fetch result:', countryResult);
        if (!countryResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Country not found', {
                countryIdNum
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
        ...
        // Fetch all states
        const statesResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$location$2f$state$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStatesByCountry"])(countryIdNum);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '❌ Error fetching single country:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Server error'
        }, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__15e9b0b0._.js.map