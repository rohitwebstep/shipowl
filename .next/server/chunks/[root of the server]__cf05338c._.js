...
"[project]/.next-internal/server/app/api/product/[productId]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "D:\\Webstep\\Shipping OWL\\2025\\April\\21\\Working\\shipping-owl\\prisma\\prisma\\generated\\client",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "D:\\Webstep\\Shipping OWL\\2025\\April\\21\\Working\\shipping-owl\\prisma\\schema.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    "inlineSchemaHash": "a9fdb9c15c641f5143f49989bdb11ec5429a729914eee3df812046b0e64e4777",
    "copyEngine": true
};
...
"[project]/src/app/models/product.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/product/[productId]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/product.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req) {
    try {
        ...
        const productResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProductById"])(productIdNum);
    ...
    try {
        ...
        const extractJSON = (key)=>{
            ...
            if (typeof value === 'object' && value !== null) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', "✅ Parsed value: 3", value);
                return value;
            }
            return null;
        };
        ...
        const { status: checkMainSKUAvailabilityResult, message: checkMainSKUAvailabilityMessage } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkMainSKUAvailabilityForUpdate"])(main_sku, productIdNum);
        ...
        const productCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateProduct"])(adminId, String(adminRole), productIdNum, productPayload);
...
async function PATCH(req) {
    try {
        ...
        const restoreResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restoreProduct"])(adminId, String(adminRole), productIdNum);
...
async function DELETE(req) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["softDeleteProduct"])(Number(adminId), String(adminRole), productIdNum); // Assuming softDeleteProduct marks the product as deleted
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__cf05338c._.js.map