...
__turbopack_context__.s({
    ...
    "refreshPendingOrdersShippingStatus": (()=>refreshPendingOrdersShippingStatus),
...
async function refreshPendingOrdersShippingStatus() {
    try {
        // Calculate the cutoff date/time (1 hour ago)
        const oneHourAgo = new Date(Date.now() - 60 * 60 * 1000);
        // Fetch orders with complete = false and lastRefreshAt <= oneHourAgo or null
        const ordersToRefresh = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.findMany({
            where: {
                complete: false,
                AND: [
                    {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `Found ${ordersToRefresh.length} orders to refresh shipping status`);
        return {
            status: true,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Error fetching orders for shipping status refresh', {
            error
        });
        return {
            status: false,
...
async function placeOrderShipping(orderId) {
    try {
        ...
        const products = await Promise.all(order.items.map(async (item)=>{
            const productRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$product$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProductById"])(item.dropshipperProductId ?? 0);
            const product = productRes?.product;
            const variantRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$product$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getProductVariantById"])(item.dropshipperProductVariantId ?? 0);
...
async function POST(req) {
    try {
        ...
        if (isObject(result) && typeof result.responsemsg === 'string') {
            ...
            data = result.data ?? null; // If you know the shape, replace any with proper type
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: true,
            message,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__2a45544b._.js.map