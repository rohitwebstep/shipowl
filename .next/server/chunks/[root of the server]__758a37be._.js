...
"[project]/.next-internal/server/app/api/order/shipping/status/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "0a7c26aad2db83aefcf5db63e83aead90db304785686c6738f4ed30cfcb4eddb",
    "copyEngine": true
};
...
__turbopack_context__.s({
    ...
    "refreshShippingApiResultOfOrder": (()=>refreshShippingApiResultOfOrder),
    "restoreOrder": (()=>restoreOrder),
    "softDeleteOrder": (()=>softDeleteOrder),
    "updateAWBNuberOfOrder": (()=>updateAWBNuberOfOrder),
    "updateOrder": (()=>updateOrder),
    "updateRTIDeliveredStatusOfOrder": (()=>updateRTIDeliveredStatusOfOrder),
...
const refreshShippingApiResultOfOrder = async (orderId, data)=>{
    try {
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.update({
            where: {
                id: orderId
...
const updateRTIDeliveredStatusOfOrder = async (orderId, status)=>{
    try {
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.update({
            where: {
                id: orderId
...
const updateAWBNuberOfOrder = async (orderId, awbNumber)=>{
    try {
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].order.update({
            where: {
                id: orderId
...
async function getOrderShippingStatus(orderId) {
    ...
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])(`debug`, `orderAWBNumber:`, orderAWBNumber);
    } catch (e) {
...
"[project]/src/app/api/order/shipping/status/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        const refreshResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["refreshPendingOrdersShippingStatus"])();
        const orders = refreshResult?.orders;
        if (!orders || orders.length === 0) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'No orders found to refresh shipping status');
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
        ...
        for (const order of orders){
            ...
            try {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])(`debug`, `shippingResult:`, shippingResult);
                if (!shippingResult?.status) {
                    ...
                    const refreshShippingApiResultOfOrderResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["refreshShippingApiResultOfOrder"])(orderId, shippingResult);
                    ...
                    const isDeliveredOrRTO = shippingData.some((item)=>{
                        const title = item.status_title.toLowerCase();
                        return title.includes('rto') || title.includes('delivered');
                    });
                    const updateRTIDeliveredStatusOfOrderResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateRTIDeliveredStatusOfOrder"])(orderId, isDeliveredOrRTO);
                    if (!updateRTIDeliveredStatusOfOrderResult || !updateRTIDeliveredStatusOfOrderResult.status) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Failed to update RTO/Delivered status for order', {
                            orderId
                        });
                        results.push({
                            orderId,
                    ...
                    const updateAWBNuberOfOrderResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateAWBNuberOfOrder"])(orderId, shippingResult.awb_number);
                    if (!updateAWBNuberOfOrderResult || !updateAWBNuberOfOrderResult.status) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Failed to update AWB Number for order', {
                            orderId
                        });
                        results.push({
                            orderId,
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Error fetching shipping status for order', {
                    orderId,
                    error
                });
                results.push({
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Error in order shipping status handler', {
            error
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__758a37be._.js.map