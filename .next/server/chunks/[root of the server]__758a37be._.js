...
__turbopack_context__.s({
    ...
    "createRTOInventory": (()=>createRTOInventory),
...
async function createRTOInventory(RTOInventory) {
    try {
        const { order, orderItem, dropshipper, dropshipperProduct, dropshipperProductVariant, quantity, price } = RTOInventory;
        // Check for existing RTO Inventory using unique orderItem ID
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].rtoInventory.findFirst({
            where: {
        ...
        const newOrder = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].rtoInventory.create({
            data: {
                order,
                orderItem,
                dropshipper,
...
async function GET(req) {
    try {
        ...
        const { orders } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["refreshPendingOrdersShippingStatus"])() || {};
        if (!orders?.length) {
        ...
        for (const order of orders){
            ...
            try {
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', '📦 shippingResult', {
                    orderId,
                    shippingResult
                });
                if (!shippingResult?.status) {
                    results.push({
                        orderId,
                        status: false,
                        message: 'Shipping status not found'
                    });
                    continue;
                }
                const shippingData = shippingResult.trackingData?.data || [];
                const [awbUpdate, apiUpdate] = await Promise.all([
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateAWBNuberOfOrder"])(orderId, shippingResult.awb_number),
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["refreshShippingApiResultOfOrder"])(orderId, shippingResult)
                ]);
                if (!awbUpdate?.status) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', '⚠️ Failed to update AWB Number', {
                        orderId
                    });
                    results.push({
                        orderId,
                        status: false,
                        message: 'AWB update failed'
                    });
                }
                if (!apiUpdate?.status || !apiUpdate.order) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', '⚠️ Failed to refresh shipping API result', {
                        orderId
                    });
                    results.push({
                        orderId,
                        status: false,
                        message: 'Shipping API result update failed'
                    });
                }
                const isDeliveredOrRTO = shippingData.some((item)=>[
                        'rto',
                        'delivered'
                    ].some((keyword)=>item.status_title.toLowerCase().includes(keyword)));
                if (isDeliveredOrRTO) {
                    const updateStatus = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateRTIDeliveredStatusOfOrder"])(orderId, true);
                    if (!updateStatus?.status) {
                        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', '⚠️ Failed to update delivered/RTO status', {
                            orderId
                        });
                        results.push({
                            orderId,
                            status: false,
                            message: 'Failed to update RTO/Delivered status'
                        });
                    }
                }
                const selfShipItems = order.items.filter((item)=>item?.variant?.supplierProductVariant?.variant?.modal === 'selfship');
                if (selfShipItems.length) {
                    (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', '📦 SelfShip Items Found', {
                        orderId,
                        count: selfShipItems.length
                    });
                    for (const item of selfShipItems){
                        ...
                        if (dropshipperId == null || dropshipperProductId == null || dropshipperProductVariantId == null) {
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', '❗ Missing required IDs for RTO inventory', {
                                orderId,
                                orderItemId: item.id,
                                dropshipperId,
                        ...
                        const payload = {
                            ...
                            dropshipperProductVariant: {
                                connect: {
                                    id: dropshipperProductVariantId
                                }
                            },
                        ...
                        try {
                            const inventoryRes = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createRTOInventory"])(payload);
                            if (!inventoryRes?.status) {
                                throw new Error('Create inventory failed');
                            }
                        } catch (error) {
                            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '❌ Inventory creation failed', {
                                orderId,
                                orderItemId: item.id,
                                error
                            });
                ...
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '🚨 Error processing shipping status', {
                    orderId,
                    error
                });
                results.push({
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '🚨 Internal server error', {
            error
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
