...
async function handleLogin(req, adminRole, adminStaffRole) {
    try {
        ...
        console.log(`admin.admin.isEmailVerified - `, admin.admin.isEmailVerified);
        ...
        if (type === 'sub' && admin.admin?.role === 'supplier') {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ed17668e._.js.map