...
"[project]/.next-internal/server/app/api/admin/supplier/[supplierId]/password/reset/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/api/admin/supplier/[supplierId]/password/reset/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        if (isStaff) {
            const permissionCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$staffPermission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkStaffPermissionStatus"])({
                panel: 'admin',
                module: 'Supplier',
                action: 'Password Change'
            }, adminId);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Staff permission check result', permissionCheck);
        ...
        const { status: emailStatus, message: emailMessage, emailConfig, htmlTemplate, subject: emailSubject } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$emailConfig$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getEmailConfig"])('admin', 'supplier', 'password-change', true);
        ...
        let htmlBody = htmlTemplate?.trim() ? htmlTemplate : '<p>Dear {{supplierName}},</p><p>Your password has been successfully changed by the admin.</p>';
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__a46d7f0b._.js.map