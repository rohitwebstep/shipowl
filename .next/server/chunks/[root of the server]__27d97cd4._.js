...
"[project]/.next-internal/server/app/api/courier-company/[courierCompanyId]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "a4999d77d26add7c9c2367594520dabcbe74c61535a9836d07dfa8c7a64b811d",
    "copyEngine": true
};
...
"[project]/src/app/models/courierCompany.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "checkCodeAvailabilityForUpdate": (()=>checkCodeAvailabilityForUpdate),
    "createCourierCompany": (()=>createCourierCompany),
    "deleteCourierCompany": (()=>deleteCourierCompany),
    "generateCourierCompanySlug": (()=>generateCourierCompanySlug),
    "getAllCourierCompanies": (()=>getAllCourierCompanies),
    "getCourierCompaniesByStatus": (()=>getCourierCompaniesByStatus),
    "getCourierCompanyById": (()=>getCourierCompanyById),
    "restoreCourierCompany": (()=>restoreCourierCompany),
    "softDeleteCourierCompany": (()=>softDeleteCourierCompany),
    "updateCourierCompany": (()=>updateCourierCompany)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
;
async function generateCourierCompanySlug(name) {
    let slug = name.toLowerCase().replace(/[^a-z0-9]/g, '-');
    let isSlugTaken = true;
    let suffix = 0;
    // Keep checking until an unused slug is found
    while(isSlugTaken){
        const existingCourierCompany = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].courierCompany.findUnique({
            where: {
                slug
            }
        });
...
async function checkCodeAvailability(code) {
    try {
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].courierCompany.findUnique({
            where: {
                code
            }
        });
...
async function checkCodeAvailabilityForUpdate(code, courierCompanyId) {
    try {
        const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].courierCompany.findUnique({
            where: {
                code,
...
async function createCourierCompany(adminId, adminRole, courierCompany) {
    try {
        const { name, code, website, email, phoneNumber, status, createdBy, createdByRole } = courierCompany;
        // Generate a unique slug for the courierCompany
        const slug = await generateCourierCompanySlug(name);
        const newCourierCompany = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].courierCompany.create({
            data: {
                name,
                slug,
                code,
        ...
        return {
            status: true,
            courierCompany: newCourierCompany
        };
    } catch (error) {
...
const updateCourierCompany = async (adminId, adminRole, courierCompanyId, data)=>{
    try {
        const { name, code, website, email, phoneNumber, status, updatedBy, updatedByRole } = data;
        const courierCompany = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].courierCompany.update({
            where: {
                id: courierCompanyId
            },
            data: {
        ...
        return {
            status: false,
            message: "Error updating courierCompany"
        };
    }
};
const getCourierCompanyById = async (id)=>{
    try {
        const courierCompany = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].courierCompany.findUnique({
            where: {
                id
            }
        });
        if (!courierCompany) return {
            status: false,
            message: "CourierCompany not found"
        };
        return {
            status: true,
            courierCompany
        ...
        return {
            status: false,
            message: "Error fetching courierCompany"
        };
    }
};
const getAllCourierCompanies = async ()=>{
    try {
        const courierCompanies = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].courierCompany.findMany({
            orderBy: {
                id: 'desc'
            }
        });
        ...
        return {
            status: false,
            message: "Error fetching courierCompanies"
        };
    }
};
const getCourierCompaniesByStatus = async (status)=>{
    try {
        let whereCondition = {};
        switch(status){
            case "active":
...
const softDeleteCourierCompany = async (adminId, adminRole, id)=>{
    try {
        const updatedCourierCompany = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].courierCompany.update({
            where: {
                id
            },
            data: {
        ...
        return {
            status: true,
            message: "CourierCompany soft deleted successfully",
        ...
        return {
            status: false,
            message: "Error soft deleting courierCompany"
        };
    }
};
const restoreCourierCompany = async (adminId, adminRole, id)=>{
    try {
        const restoredCourierCompany = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].courierCompany.update({
            where: {
                id
            },
            data: {
        ...
        return {
            status: true,
            message: "CourierCompany restored successfully",
            restoredCourierCompany
        };
    } catch (error) {
        console.error("❌ restoreCourierCompany Error:", error);
        return {
            status: false,
            message: "Error restoring courierCompany"
        };
    }
};
const deleteCourierCompany = async (id)=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].courierCompany.delete({
            where: {
                id
            }
        });
        return {
            status: true,
            message: "CourierCompany deleted successfully"
        };
    } catch (error) {
        console.error("❌ deleteCourierCompany Error:", error);
        return {
            status: false,
            message: "Error deleting courierCompany"
        };
    }
};
}}),
"[project]/src/app/api/courier-company/[courierCompanyId]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$courierCompany$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/courierCompany.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Requested CourierCompany ID:', courierCompanyId);
        ...
        if (isNaN(courierCompanyIdNum)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Invalid courierCompany ID', {
                courierCompanyId
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid courierCompany ID'
            }, {
                status: 400
            });
        }
        const courierCompanyResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$courierCompany$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCourierCompanyById"])(courierCompanyIdNum);
        if (courierCompanyResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'CourierCompany found:', courierCompanyResult.courierCompany);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                courierCompany: courierCompanyResult.courierCompany
            }, {
                status: 200
            });
        }
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '❌ Error fetching single courierCompany:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Server error'
        }, {
...
async function PUT(req) {
    try {
        ...
        const courierCompanyResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$courierCompany$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getCourierCompanyById"])(courierCompanyIdNum);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'CourierCompany fetch result:', courierCompanyResult);
        if (!courierCompanyResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'CourierCompany not found', {
                courierCompanyIdNum
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
        ...
        const { status: checkCodeAvailabilityResult, message: checkCodeAvailabilityMessage } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$courierCompany$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkCodeAvailabilityForUpdate"])(code, courierCompanyIdNum);
        if (!checkCodeAvailabilityResult) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', `SKU availability check failed: ${checkCodeAvailabilityMessage}`);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: checkCodeAvailabilityMessage
            }, {
                status: 400
            });
        }
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'CourierCompany payload:', courierCompanyPayload);
        const courierCompanyCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$courierCompany$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateCourierCompany"])(adminId, String(adminRole), courierCompanyIdNum, courierCompanyPayload);
        if (courierCompanyCreateResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'CourierCompany updated successfully:', courierCompanyCreateResult.courierCompany);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                courierCompany: courierCompanyCreateResult.courierCompany
            }, {
                status: 200
            });
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'CourierCompany update failed', courierCompanyCreateResult?.message);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: courierCompanyCreateResult?.message || 'CourierCompany creation failed'
        }, {
            status: 500
        });
    } catch (err) {
        const error = err instanceof Error ? err.message : 'Internal Server Error';
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '❌ CourierCompany Updation Error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error
        }, {
...
async function PATCH(req) {
    try {
        ...
        const restoreResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$courierCompany$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restoreCourierCompany"])(adminId, String(adminRole), courierCompanyIdNum);
        if (restoreResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'CourierCompany restored successfully:', restoreResult.restoredCourierCompany);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                courierCompany: restoreResult.restoredCourierCompany
            }, {
                status: 200
            });
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'CourierCompany restore failed');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'CourierCompany restore failed'
        }, {
            status: 500
        });
    } catch (error) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '❌ CourierCompany restore error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Server error'
        }, {
...
async function DELETE(req) {
    try {
        // Extract courierCompanyId directly from the URL path
        const courierCompanyId = req.nextUrl.pathname.split('/').pop();
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Delete CourierCompany Request:', {
            courierCompanyId
        });
        ...
        const courierCompanyIdNum = Number(courierCompanyId);
        if (isNaN(courierCompanyIdNum)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Invalid courierCompany ID format', {
                courierCompanyId
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'CourierCompany ID is invalid'
            }, {
                status: 400
            });
        }
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$courierCompany$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["softDeleteCourierCompany"])(Number(adminId), String(adminRole), courierCompanyIdNum); // Assuming softDeleteCourierCompany marks the courierCompany as deleted
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `Soft delete request for courierCompany: ${courierCompanyIdNum}`, {
            adminId
        });
        if (result?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `CourierCompany soft deleted successfully: ${courierCompanyIdNum}`, {
                adminId
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `CourierCompany not found or could not be deleted: ${courierCompanyIdNum}`, {
            adminId
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            message: 'CourierCompany not found or deletion failed'
        }, {
            status: 404
        });
    } catch (error) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Error during courierCompany deletion', {
            error
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__27d97cd4._.js.map