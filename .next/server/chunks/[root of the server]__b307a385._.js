...
"[project]/.next-internal/server/app/api/admin/supplier/bank-account/change-request/[bankAccountChangeRequestId]/review/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "86431021a4abca6f5a8ac0227948a048fe10f7b2edcce5003188a1213b8a3bfe",
    "copyEngine": true
};
...
"[project]/src/app/models/supplier/bankAccount.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "getAllBankAccountChangeRequests": (()=>getAllBankAccountChangeRequests),
    "getBankAccountById": (()=>getBankAccountById),
    "getBankAccountChangeRequestByAdminId": (()=>getBankAccountChangeRequestByAdminId),
    "getBankAccountChangeRequestById": (()=>getBankAccountChangeRequestById),
    "getSupplierBankAccountBySupplierId": (()=>getSupplierBankAccountBySupplierId),
    "removeBankAccountImageByIndex": (()=>removeBankAccountImageByIndex),
    "requestSupplierBankAccountChange": (()=>requestSupplierBankAccountChange),
    "reviewBankAccountChangeRequest": (()=>reviewBankAccountChangeRequest),
...
const getBankAccountById = async (id)=>{
    try {
        const bankAccount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bankAccount.findUnique({
            where: {
                id
            }
        });
...
async function getSupplierBankAccountBySupplierId(supplierId) {
    try {
        const bankAccount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bankAccount.findFirst({
            where: {
                adminId: supplierId
            }
        });
        if (!bankAccount) {
            return {
                status: false,
                message: "No bank account found for this supplier."
            };
        }
        return {
            status: true,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])("error", "Error fetching bank account by supplierId", error);
        return {
            status: false,
            message: "Internal Server Error"
        };
...
async function getBankAccountChangeRequestByAdminId(adminId) {
    try {
        // Check if there's already an existing bank account change request for the given adminId
        const bankAccountChangeRequest = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bankAccountChangeRequest.findFirst({
            where: {
                adminId: adminId
            }
        });
        ...
        if (bankAccountChangeRequest) {
            return {
                status: true,
                bankAccountChangeRequest: serializeBigInt(bankAccountChangeRequest)
            };
        }
        // If no existing request is found, return a message
        return {
            status: false,
            message: "No bank account change request found for this admin."
        };
    } catch (error) {
        // Log the error and return a failure response
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])("error", "Error fetching bank account change request", error);
        return {
            status: false,
            message: "Internal Server Error"
        };
...
async function getBankAccountChangeRequestById(id) {
    try {
        // Find the bank account change request by its unique ID
        const bankAccountChangeRequest = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bankAccountChangeRequest.findUnique({
            where: {
                id: id
            }
        });
        ...
        return {
            status: false,
            message: "No bank account change request found with this ID."
        };
    } catch (error) {
        // Log error and return failure response
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])("error", "Error fetching bank account change request by ID", error);
        return {
            status: false,
            message: "Internal Server Error"
        };
...
async function createSupplierBankAccount(adminId, adminRole, payload) {
    try {
        ...
        const newBankAccounts = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bankAccount.createMany({
            data: {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])("error", "Error creating supplier bank account", error);
        return {
            status: false,
            message: "Internal Server Error"
        };
...
const removeBankAccountImageByIndex = async (bankAccountId, supplierId, imageType, imageIndex)=>{
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])(`debbug`, `bankAccount:`, bankAccount);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])(`debbug`, `imageType:`, imageType);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])(`debbug`, `images.length:`, images.length);
...
async function updateSupplierBankAccount(adminId, adminRole, supplierId, payload) {
    try {
        const { admin, bankAccount, accountHolderName, accountNumber, bankName, bankBranch, accountType, ifscCode, cancelledChequeImage, updatedAt, updatedBy, updatedByRole } = payload;
        if (bankAccount?.connect?.id) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bankAccount.update({
                where: {
                    id: bankAccount.connect.id
                },
                data: {
                    adminId: admin.connect.id,
                    accountHolderName,
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bankAccount.create({
                data: {
                    adminId: admin.connect.id,
                    accountHolderName,
                    accountNumber,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])("error", "Error updating/creating supplier bank account", error);
        return {
            status: false,
            message: "Internal Server Error"
        };
...
async function requestSupplierBankAccountChange(supplierId, supplierRole, payload) {
    try {
        const { admin, accountHolderName, accountNumber, bankName, bankBranch, accountType, ifscCode, cancelledChequeImage, createdAt, createdBy, createdByRole } = payload;
        ...
        const newBankAccount = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bankAccountChangeRequest.create({
            data: {
                adminId: admin.connect.id,
                accountHolderName,
                accountNumber,
        ...
        return {
            status: true,
            bankAccount: serializeBigInt(newBankAccount)
        };
    } catch (error) {
        // Log the error and return a failure response
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])("error", "Error creating supplier bank account change request", error);
        return {
            status: false,
            message: "Internal Server Error"
        };
...
const getAllBankAccountChangeRequests = async ()=>{
    try {
        const requests = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bankAccountChangeRequest.findMany({
            include: {
                supplier: {
                    include: {
                        bankAccount: true
...
async function reviewBankAccountChangeRequest(adminId, adminRole, isApproved, bankAccountChangeRequestId) {
    try {
        const { status: changeRequestStatus, bankAccountChangeRequest } = await getBankAccountChangeRequestById(bankAccountChangeRequestId);
        if (!changeRequestStatus || !bankAccountChangeRequest) {
            return {
                status: false,
                message: "Bank account change request not found."
            };
        }
        if (isApproved) {
            const { adminId: supplierId, accountHolderName, accountNumber, bankName, bankBranch, accountType, ifscCode, cancelledChequeImage } = bankAccountChangeRequest;
            const { status: bankAccountStatus, bankAccount } = await getSupplierBankAccountBySupplierId(supplierId);
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].bankAccountChangeRequest.delete({
                where: {
                    id: bankAccountChangeRequestId
                }
            });
            return {
                status: true,
                message: "Bank account change request approved."
            };
        } else {
            ...
            return {
                status: true,
                message: "Bank account change request rejected and deleted."
            };
        }
    } catch (error) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])("error", "Error in reviewing bank account change request", error);
        return {
            status: false,
            message: "Internal Server Error"
        };
...
"[project]/src/app/api/admin/supplier/bank-account/change-request/[bankAccountChangeRequestId]/review/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$bankAccount$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/supplier/bankAccount.ts [app-route] (ecmascript)");
;
;
;
;
async function POST(req) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Bank Account Change Request ID extracted:', {
            bankAccountChangeRequestId
        });
        ...
        if (isNaN(bankAccountChangeRequestIdNum)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Invalid bank account change request ID', {
                bankAccountChangeRequestId
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
        ...
        // Fetch request by ID
        const requestResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$bankAccount$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBankAccountChangeRequestById"])(bankAccountChangeRequestIdNum);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Bank account change request fetch result:', requestResult);
        if (!requestResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Bank account change request not found', {
                bankAccountChangeRequestIdNum
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
        ...
        const reviewResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$bankAccount$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["reviewBankAccountChangeRequest"])(adminId, String(adminRole), finalStatus, bankAccountChangeRequestIdNum);
        if (reviewResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Bank account change request review processed successfully:', reviewResult.message);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Bank account change request review failed');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '❌ Review API error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Server error'
        }, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b307a385._.js.map