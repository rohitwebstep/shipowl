...
;
;
async function checkAdminPermission({ admin_id, admin_type, role, module, action }) {
    console.log('%c[Admin Permission Check]', 'color: blue; font-weight: bold;');
    console.table({
        admin_id,
        admin_type,
        role,
    ...
    // print userCheck found
    console.log('%c[User Check]', 'color: green; font-weight: bold;');
    console.table(userCheck);
    // Simulated permission check — replace with real logic later
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__8ca99a88._.js.map