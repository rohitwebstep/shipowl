...
"[project]/.next-internal/server/app/api/dropshipper/auth/registration/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/models/dropshipper/dropshipper.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "createDropshipper": (()=>createDropshipper),
    "deleteDropshipper": (()=>deleteDropshipper),
    "getDropshipperById": (()=>getDropshipperById),
    "getDropshippersByStatus": (()=>getDropshippersByStatus),
    "restoreDropshipper": (()=>restoreDropshipper),
    "softDeleteDropshipper": (()=>softDeleteDropshipper),
...
async function checkEmailAvailability(email) {
    try {
        ...
        const existingDropshipper = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.findFirst({
            where: {
                email
            },
            select: {
...
async function checkEmailAvailabilityForUpdate(email, dropshipperId) {
    try {
        // Query to find if an email already exists with role 'dropshipper'
        const existingDropshipper = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.findFirst({
            where: {
...
async function createDropshipper(adminId, adminRole, dropshipper) {
    try {
        ...
        const newDropshipper = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.create({
            data: {
                name,
                profilePicture,
                email,
        ...
        return {
            status: true,
            dropshipper: serializeBigInt(newDropshipper)
        };
    } catch (error) {
        console.error(`Error creating city:`, error);
        return {
...
const getDropshippersByStatus = async (status = "notDeleted", withPassword = false)=>{
    try {
        let whereCondition = {};
        switch(status){
            case "notDeleted":
        ...
        const dropshippers = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.findMany({
            where: whereCondition,
            orderBy: {
                name: "asc"
            },
        ...
        return {
            status: true,
            dropshippers: serializeBigInt(dropshippers)
        };
    } catch (error) {
        console.error(`Error fetching dropshippers by status (${status}):`, error);
        return {
            status: false,
            message: "Error fetching dropshippers"
        };
    }
};
const getDropshipperById = async (id, withPassword = false)=>{
    try {
        const dropshipper = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.findUnique({
            where: {
                id,
                role: 'dropshipper'
            },
        ...
        return {
            status: true,
            dropshipper: serializeBigInt(dropshipper)
        };
    } catch (error) {
        console.error("❌ getDropshipperById Error:", error);
        return {
            status: false,
            message: "Error fetching dropshipper"
        };
    }
};
const updateDropshipper = async (adminId, adminRole, dropshipperId, dropshipper, withPassword = false)=>{
    try {
        const { name, profilePicture, email, website, referralCode, phoneNumber, permanentAddress, permanentPostalCode, permanentCity, permanentState, permanentCountry, status: statusRaw, updatedAt, updatedBy, updatedByRole } = dropshipper;
        // Convert statusRaw to a boolean using the includes check
        const status = [
            'true',
            '1',
...
const softDeleteDropshipper = async (adminId, adminRole, id)=>{
    try {
        // Soft delete the dropshipper
        const updatedDropshipper = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.update({
            where: {
                id,
                role: 'dropshipper'
            },
        ...
        return {
            status: false,
            message: "Error soft deleting dropshipper"
        };
    }
};
const restoreDropshipper = async (adminId, adminRole, id)=>{
    try {
        // Restore the dropshipper
        const restoredDropshipper = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].admin.update({
            where: {
                id
            },
            include: {
        ...
        return {
            status: false,
            message: "Error restoring dropshipper"
        };
    }
};
const deleteDropshipper = async (id)=>{
    try {
        console.log(`id - `, id);
        ...
        return {
            status: false,
            message: "Error deleting dropshipper"
        };
    }
};
}}),
...
"[project]/src/app/api/dropshipper/auth/registration/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$dropshipper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/dropshipper/dropshipper.ts [app-route] (ecmascript)");
...
async function POST(req) {
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'POST request received for dropshipper updation');
        ...
        const { status: checkEmailAvailabilityResult, message: checkEmailAvailabilityMessage } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$dropshipper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkEmailAvailability"])(email);
    ...
    */ const dropshipperUploadDir = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'tmp', 'uploads', 'dropshipper');
        ...
        const dropshipperUploadedFiles = {};
        for (const field of dropshipperFileFields){
            ...
            if (fileData) {
                ...
                if (Array.isArray(fileData)) {
                    dropshipperUploadedFiles[field] = fileData.map((file)=>file.url).join(', ');
                } else {
                    dropshipperUploadedFiles[field] = fileData.url;
                }
            }
        }
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Dropshipper payload updated:', dropshipperPayload);
        const dropshipperCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$dropshipper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createDropshipper"])(0, String(''), dropshipperPayload);
        if (!dropshipperCreateResult || !dropshipperCreateResult.status || !dropshipperCreateResult.dropshipper) {
            ...
            if (Object.keys(dropshipperUploadedFiles).length > 0) {
                ...
                for(const field in dropshipperUploadedFiles){
                    ...
                    for (const fileUrl of fileUrls){
                        if (fileUrl) {
                            const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(dropshipperUploadDir, __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(fileUrl));
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Dropshipper creation failed:', dropshipperCreateResult?.message || 'Unknown error');
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: dropshipperCreateResult?.message || 'Dropshipper creation failed'
            }, {
                status: 500
            });
        }
        ...
        */ const { status: emailStatus, message: emailMessage, emailConfig, htmlTemplate, subject: emailSubject } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$emailConfig$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getEmailConfig"])('dropshipper', 'auth', 'registration', true);
        ...
        let verificationLink = `https://shipowl.io/dropshipping/auth/regist/reset?token=${token}`;
        ...
        let htmlBody = htmlTemplate?.trim() ? htmlTemplate : "<p>Dear {{name}},</p><p>Click <a href='{{verificationLink}}'>here</a> to verify your email.</p>";
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: true,
            error: dropshipperCreateResult?.message || 'Dropshipper updated Successfuly'
        }, {
            status: 200
        });
    } catch (err) {
        const error = err instanceof Error ? err.message : 'Internal Server Error';
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Dropshipper Creation Error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error
        }, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__9604b6c7._.js.map