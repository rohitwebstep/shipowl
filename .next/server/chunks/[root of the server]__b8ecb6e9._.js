...
const isLocationHierarchyCorrect = async (cityId, stateId, countryId)=>{
    try {
        ...
        if (!country) {
            ...
            return {
                status: false,
                message: "The specified country could not be found. Please check the country ID."
            };
        }
        ...
        if (!state) {
            ...
            return {
                status: false,
                message: "The specified state could not be found. Please check the state ID."
            };
        }
        if (state.countryId.toString() !== countryId.toString()) {
            ...
            return {
                status: false,
                message: "The specified state does not belong to the given country. Please check the state and country relationship."
            };
        }
        ...
        if (!city) {
            ...
            return {
                status: false,
                message: "The specified city could not be found. Please check the city ID."
            };
        }
        if (city.stateId.toString() !== stateId.toString()) {
            ...
            return {
                status: false,
                message: "The specified city does not belong to the given state. Please check the city and state relationship."
            };
        }
...
async function GET(req) {
    try {
        ...
        if (cityResult?.status) {
            ...
            // Fetch all states
            const statesResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$location$2f$state$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStatesByCountry"])(Number(cityResult?.city?.countryId));
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Countries fetched successfully:', countriesResult.countries);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
...
async function PUT(req) {
    try {
        ...
        if (isNaN(countryIdNum) || isNaN(stateIdNum)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Invalid country or state ID', {
                countryId,
                stateId
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Invalid country or state ID'
            }, {
                status: 400
            });
        }
        ...
        const stateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$location$2f$state$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getStateById"])(stateIdNum);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'State fetch result:', stateResult);
        if (!stateResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'State not found', {
                stateIdNum
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
        ...
        const isStateInCountryResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$location$2f$state$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isStateInCountry"])(stateId, countryId);
        if (!isStateInCountryResult.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', `State not found in country: ${isStateInCountryResult.message}`);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: isStateInCountryResult.message
            }, {
                status: 400
            });
        }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__b8ecb6e9._.js.map