...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/order/order.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$order$2f$getOrderShippingStatus__$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/order/getOrderShippingStatus .ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req) {
    try {
        ...
        const orderId = parts[parts.length - 3]; // Get the second-to-last segment
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Delete order Request:', {
            orderId
        });
        ...
        const getOrderShippingStatusResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$order$2f$getOrderShippingStatus__$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrderShippingStatus"])(orderIdNum);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Order shipping status result:', getOrderShippingStatusResult);
        if (!getOrderShippingStatusResult.status) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: true,
            getOrderShippingStatusResult,
            message: 'Order shipping status found'
        }, {
            status: 200
        });
        "TURBOPACK unreachable";
        const orderResult = undefined;
        const order = undefined;
        let orderAWBNumber;
    } catch (error) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '❌ Error fetching single order:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Server error'
        }, {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__ea0fa3d8._.js.map