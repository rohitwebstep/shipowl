...
"[project]/.next-internal/server/app/api/admin/staff/[adminStaffId]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "a049a93fd8b38b4fda329fd50025b3128ce03248a8154b869848ce94ad0add81",
    "copyEngine": true
};
...
"[project]/src/app/models/admin/staff.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
__turbopack_context__.s({
    ...
    "createAdminStaff": (()=>createAdminStaff),
    "deleteAdminStaff": (()=>deleteAdminStaff),
    "getAdminStaffById": (()=>getAdminStaffById),
    "getAdminStaffsByStatus": (()=>getAdminStaffsByStatus),
    "restoreAdminStaff": (()=>restoreAdminStaff),
    "softDeleteAdminStaff": (()=>softDeleteAdminStaff),
    "updateAdminStaff": (()=>updateAdminStaff)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/path [external] (path, cjs)");
...
async function checkEmailAvailability(email) {
    try {
        ...
        const existingAdminStaff = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminStaff.findFirst({
            where: {
                email
            },
            select: {
...
async function checkEmailAvailabilityForUpdate(email, adminStaffId) {
    try {
        // Query to find if an email already exists with role 'adminStaff'
        const existingAdminStaff = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminStaff.findFirst({
            where: {
...
async function createAdminStaff(adminId, adminRole, adminStaff) {
    try {
        ...
        const newAdminStaff = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminStaff.create({
            data: {
                admin,
                name,
                profilePicture,
        ...
        return {
            status: true,
            adminStaff: serializeBigInt(newAdminStaff)
        };
    } catch (error) {
        console.error(`Error creating city:`, error);
        return {
...
const getAdminStaffsByStatus = async (status = "notDeleted", withPassword = false)=>{
    try {
        let whereCondition = {};
        switch(status){
            case "notDeleted":
        ...
        const adminStaffs = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminStaff.findMany({
            where: whereCondition,
            orderBy: {
                name: "asc"
            },
        ...
        return {
            status: true,
            adminStaffs: serializeBigInt(adminStaffs)
        };
    } catch (error) {
        console.error(`Error fetching adminStaffs by status (${status}):`, error);
        return {
            status: false,
            message: "Error fetching adminStaffs"
        };
    }
};
const getAdminStaffById = async (id, withPassword = false)=>{
    try {
        const adminStaff = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminStaff.findUnique({
            where: {
                id,
                role: 'admin_staff'
            },
        ...
        if (!adminStaff) return {
            status: false,
            message: "AdminStaff not found"
        };
        return {
            status: true,
            adminStaff: serializeBigInt(adminStaff)
        };
    } catch (error) {
        console.error("❌ getAdminStaffById Error:", error);
        return {
            status: false,
            message: "Error fetching adminStaff"
        };
    }
};
const updateAdminStaff = async (adminStaffId, adminStaffRole, adminStaff, withPassword = false)=>{
    try {
        const { admin, name, profilePicture, email, phoneNumber, permanentAddress, permanentPostalCode, permanentCity, permanentState, permanentCountry, status: statusRaw, updatedAt, updatedBy, updatedByRole } = adminStaff;
        // Convert statusRaw to a boolean using the includes check
        const status = [
            'true',
            '1',
        ...
        if (!adminStaffStatus || !currentAdminStaff) {
            return {
                status: false,
                message: message || "AdminStaff not found."
            };
        }
        ...
        if (profilePicture && profilePicture.trim() !== '' && currentAdminStaff?.profilePicture?.trim()) {
            try {
                const imageFileName = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].basename(currentAdminStaff.profilePicture.trim());
                const filePath = __TURBOPACK__imported__module__$5b$externals$5d2f$path__$5b$external$5d$__$28$path$2c$__cjs$29$__["default"].join(process.cwd(), 'public', 'uploads', 'adminStaff');
        ...
        const newAdminStaff = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminStaff.update({
            where: {
                id: adminStaffId
            },
            data: updateData
...
const softDeleteAdminStaff = async (adminId, adminStaffRole, id)=>{
    try {
        // Soft delete the adminStaff
        const updatedAdminStaff = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminStaff.update({
            where: {
                id,
                role: 'admin_staff'
            },
        ...
        return {
            status: false,
            message: "Error soft deleting adminStaff"
        };
    }
};
const restoreAdminStaff = async (adminId, adminStaffRole, id)=>{
    try {
        // Restore the adminStaff
        const restoredAdminStaff = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminStaff.update({
            where: {
                id
            },
            include: {
            ...
            data: {
                ...
                deletedByRole: null,
                updatedBy: adminId,
                updatedByRole: adminStaffRole,
                updatedAt: new Date()
            }
        });
        // Restore the variants of this adminStaff
        ...
        return {
            status: false,
            message: "Error restoring adminStaff"
        };
    }
};
const deleteAdminStaff = async (id)=>{
    try {
        console.log(`id - `, id);
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminStaff.delete({
            where: {
                id,
                role: 'admin_staff'
            }
        ...
        return {
            status: true,
            message: "AdminStaff deleted successfully"
        };
    } catch (error) {
        console.error("❌ deleteAdminStaff Error:", error);
        return {
            status: false,
            message: "Error deleting adminStaff"
        };
    }
};
}}),
...
{
__turbopack_context__.s({
    "assignAdminStaffPermission": (()=>assignAdminStaffPermission),
    "getAdminPermissionById": (()=>getAdminPermissionById),
    "getAdminStaffPermissionsByStatus": (()=>getAdminStaffPermissionsByStatus),
    "getAllAdminStaffPermissions": (()=>getAllAdminStaffPermissions),
    "getPermissionsOfAdminStaff": (()=>getPermissionsOfAdminStaff)
});
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/prisma.ts [app-route] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/utils/commonUtils.ts [app-route] (ecmascript)");
;
...
async function assignAdminStaffPermission(adminStaffId, adminRole, payload) {
    try {
        const permissionOperations = payload.permissions.map(async (permission)=>{
            ...
            const existingPermission = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminStaffHasPermission.findFirst({
                where: {
            ...
            const newPermission = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminStaffHasPermission.create({
                data: {
                    adminStaffId: targetAdminId,
                    permissionId: targetPermissionId,
...
const getAllAdminStaffPermissions = async ()=>{
    try {
...
const getAdminStaffPermissionsByStatus = async (status)=>{
    try {
        let whereCondition = {
            panel: "admin"
        };
...
const getPermissionsOfAdminStaff = async (adminStaffId)=>{
    try {
        ...
        const permissions = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].adminStaffHasPermission.findMany({
            where: {
                adminStaffId
            },
            include: {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])("error", `Failed to get permissions for adminStaffId ${adminStaffId}`, error);
        return {
            status: false,
...
"[project]/src/app/api/admin/staff/[adminStaffId]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$staff$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/admin/staff.ts [app-route] (ecmascript)");
...
async function GET(req) {
    try {
        ...
        const adminStaffResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$staff$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAdminStaffById"])(Number(adminStaffId));
        if (adminStaffResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Admin found:', adminStaffResult.adminStaff);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                adminStaff: adminStaffResult.adminStaff
            }, {
                status: 200
            });
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Admin Staff found:', adminStaffResult.adminStaff);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '❌ Error fetching single admin:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Server error'
        }, {
...
async function PUT(req) {
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'POST request received for admin updation');
        const adminStaffId = req.nextUrl.pathname.split('/').pop();
        ...
        const adminStaffResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$staff$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAdminStaffById"])(Number(adminStaffId));
        if (!adminStaffResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', `Admin Staff not found: ${adminStaffResult.message}`, {
                adminStaffId
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Admin Staff not found: ${adminStaffResult.message}`
            }, {
                status: 404
            });
        }
        ...
        const { status: checkEmailAvailabilityResult, message: checkEmailAvailabilityMessage } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$staff$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkEmailAvailabilityForUpdate"])(email, Number(adminStaffId));
        ...
        const adminStaffCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$staff$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateAdminStaff"])(Number(adminStaffId), String(adminRole), adminPayload);
        if (!adminStaffCreateResult || !adminStaffCreateResult.status || !adminStaffCreateResult.adminStaff) {
            ...
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Admin creation failed:', adminStaffCreateResult?.message || 'Unknown error');
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                error: adminStaffCreateResult?.message || 'Admin creation failed'
            }, {
                status: 500
            });
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Admin Staff\'s permissions:', permissions);
        ...
        const adminPermissionCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assignAdminStaffPermission"])(adminId, String(adminRole), adminPermissionPayload);
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: true,
            error: adminStaffCreateResult?.message || 'Admin created Successfuly'
        }, {
            status: 200
        });
    } catch (err) {
...
async function PATCH(req) {
    try {
        ...
        const restoreAdminStaffResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$staff$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restoreAdminStaff"])(adminId, String(adminRole), Number(adminStaffId));
        if (restoreAdminStaffResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Admin restored successfully:', restoreAdminStaffResult.restoredAdminStaff);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                admin: restoreAdminStaffResult.restoredAdminStaff
            }, {
                status: 200
            });
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Admin restore failed');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Admin restore failed'
        }, {
            status: 500
        });
    } catch (error) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', '❌ Admin restore error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Server error'
        }, {
...
async function DELETE(req) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$staff$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["softDeleteAdminStaff"])(Number(adminId), String(adminRole), Number(adminStaffId)); // Assuming softDeleteAdmin marks the admin as deleted
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `Soft delete request for admin: ${adminId}`, {
            adminId
        });
        if (result?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `Admin soft deleted successfully: ${adminId}`, {
                adminId
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `Admin not found or could not be deleted: ${adminId}`, {
            adminId
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            message: 'Admin not found or deletion failed'
        }, {
            status: 404
        });
    } catch (error) {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Error during admin deletion', {
            error
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__792e0cba._.js.map