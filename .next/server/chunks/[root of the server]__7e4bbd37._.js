...
"[project]/.next-internal/server/app/api/admin/product/[productId]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
const updateProduct = async (adminId, adminRole, productId, product)=>{
    try {
        ...
        if (variants && variants.length > 0) {
            ...
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].productVariant.deleteMany({
                where: {
                    productId: productId,
...
"[project]/src/app/api/admin/product/[productId]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    try {
        ...
        if (isStaff) {
            ...
            const staffPermissionsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$staffPermission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkStaffPermissionStatus"])(options, adminId);
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Fetched staff permissions:', staffPermissionsResult);
...
async function PUT(req) {
    try {
        ...
        const productCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$product$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateProduct"])(adminId, String(adminRole), productIdNum, productPayload);
        if (productCreateResult?.status) {
            if (!isVisibleToAll && supplierIds.length > 0) {
                if (productCreateResult.status && productCreateResult.product) {
                    const visibilityResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$product$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["assignProductVisibilityToSuppliers"])(adminId, String(adminRole), productIdNum, supplierIds);
...
async function PATCH(req) {
    try {
        ...
        const restoreResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$product$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restoreProduct"])(adminId, String(adminRole), productIdNum);
...
async function DELETE(req) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$product$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["softDeleteProduct"])(Number(adminId), String(adminRole), productIdNum); // Assuming softDeleteProduct marks the product as deleted
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__7e4bbd37._.js.map