 ...
 */ const config = {
    ...
    "inlineSchemaHash": "ebbd605a9133cec92b192d01989266682f0a0f86ac58ca48025b36c765cedb6a",
    "copyEngine": true
};
...
async function createSupplier(adminId, adminRole, supplier) {
    try {
        ...
        const sanitizedSuppliers = serializeBigInt(newSupplier);
        return {
            status: true,
            supplier: sanitizedSuppliers
        };
    } catch (error) {
        console.error(`Error creating city:`, error);
        return {
...
async function POST(req) {
    try {
        ...
        const { status: checkUsernameAvailabilityResult, message: checkUsernameAvailabilityMessage } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkUsernameAvailability"])(username);
        ...
        const supplierCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createSupplier"])(adminId, String(adminRole), supplierPayload);
        if (supplierCreateResult?.status) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                supplier: supplierCreateResult.supplier
            }, {
                status: 200
            });
        }
...
async function GET(req) {
    try {
        ...
        // Fetch all suppliers
        const suppliersResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getSuppliersByStatus"])("notDeleted");
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__cc8388a2._.js.map