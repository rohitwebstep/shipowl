...
async function handleForgetPassword(req, adminRole, adminStaffRole) {
    try {
        ...
        const { status, message, emailConfig, htmlTemplate } = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$emailConfig$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getEmailConfig"])("admin", "auth", "forget-password", true);
        console.log(`{ status, message, emailConfig, htmlTemplate } - `, {
            status,
            message,
            emailConfig,
            htmlTemplate
        ...
        if (!status || !emailConfig) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: message || "Failed to fetch email configuration.",
                status: false
            }, {
                status: 500
            });
...
async function handleResetPassword(req, adminRole, adminStaffRole) {
    try {
        ...
        if (!status || !admin) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                message: message || "Invalid token or role",
                status: false
            }, {
                status: 401
            });
        ...
        const smtpConfig = {
            ...
            port: 465,
            secure: true,
            username: "rohitwebstep@gmail.com",
            password: "dxoaeeczgiapoybi",
            from_email: "rohitwebstep@gmail.com",
            from_name: "Inspire Tuition"
        };
        const mailData = {
            recipient: [
                {
        ...
        const emailResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$email$2f$sendEmail$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["sendEmail"])(smtpConfig, mailData);
        if (!emailResult.success) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__635fcd51._.js.map