...
"[project]/.next-internal/server/app/api/admin/dropshipper/[dropshipperId]/payment-report/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    ...
    "inlineSchemaHash": "27184a997196385cda66b8a596d4c41cabbc011b5292531cfe1847d2944a1264",
    "copyEngine": true
};
...
__turbopack_context__.s({
    ...
    "getOrdersByStatusForReporting": (()=>getOrdersByStatusForReporting),
...
const getOrdersByStatusForReporting = async (status, dropshipperId, fromDate, toDate)=>{
    try {
...
"[project]/src/app/models/app/appConfig.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const getAppConfig = async ()=>{
    try {
        const appConfig = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].appConfig.findFirst({
            where: {
                status: true
            },
            orderBy: {
        ...
        return {
            status: true,
            appConfig: serializeBigInt(appConfig)
        };
    } catch (error) {
        console.error("❌ getAppConfig Error:", error);
        return {
            status: false,
            message: "Error fetching AppConfig"
        };
    }
};
}}),
...
"[project]/src/app/api/admin/dropshipper/[dropshipperId]/payment-report/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$app$2f$appConfig$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/app/appConfig.ts [app-route] (ecmascript)");
...
async function GET(req) {
    try {
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'Delete Dropshipper Request:', {
            dropshipperId
        });
        ...
        if (isNaN(dropshipperIdNum)) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Invalid dropshipper ID format', {
                dropshipperId
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Dropshipper ID is invalid'
            }, {
                status: 400
            });
        }
        const dropshipperResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$dropshipper$2f$dropshipper$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getDropshipperById"])(dropshipperIdNum);
        if (!dropshipperResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('warn', 'Dropshipper not found', {
                dropshipperIdNum
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
        ...
        const extractDate = (value, outputFormat)=>{
            ...
            const formatDate = (date, format)=>{
                ...
                return format === 'YYYY-MM-DD' ? formattedDate.split('/').reverse().join('-') : formattedDate.replace(/\//g, '-');
            };
        ...
        const ordersResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$order$2f$order$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getOrdersByStatusForReporting"])('completedOrRto', dropshipperIdNum, fromDate, toDate);
        ...
        const appConfigResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$app$2f$appConfig$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getAppConfig"])();
        ...
        orders.forEach((order)=>{
            ...
            const orderType = order.isPostpaid ? 'postpaid' : 'prepaid';
            ...
            orderItems.forEach((item)=>{
                ...
                if (modal === 'shipowl') {
                    ...
                    reportAnalytics.shipowl.remittanceToDropshipper += orderItemQty * Number(dropshipperVariant.price || 0) - (orderItemQty * Number(supplierVariant.price || 0) + totalShippingCost);
                    ...
                    section.remittanceToDropshipper += orderItemQty * Number(dropshipperVariant.price || 0) - (orderType === 'postpaid' ? orderItemQty * Number(supplierVariant.price || 0) + totalShippingCost : totalShippingCost);
                }
            });
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: true,
            reportAnalytics: reportAnalytics.shipowl
        }, {
            status: 200
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__dd839181._.js.map