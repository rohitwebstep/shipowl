 ...
 */ const config = {
    ...
    "inlineSchemaHash": "ed0825690bb28db9fdc23cfe285f4eafeff1987b9b1c28a4e3b56e4e9a198c4a",
    "copyEngine": true
};
...
const updateSupplierProduct = async (supplierId, supplierRole, supplierProductId, product)=>{
    try {
        const { productId, supplierId, stock, price, status, updatedBy, updatedByRole } = product;
