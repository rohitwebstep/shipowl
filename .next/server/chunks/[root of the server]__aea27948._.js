...
"[project]/.next-internal/server/app/api/supplier/product/[supplierProductId]/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
"[project]/src/app/models/supplier/product.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";

var { g: global, __dirname } = __turbopack_context__;
{
__turbopack_context__.s({
    "checkProductForSupplier": (()=>checkProductForSupplier),
    "checkSupplierProductForSupplier": (()=>checkSupplierProductForSupplier),
    ...
    "restoreSupplierProduct": (()=>restoreSupplierProduct),
    "softDeleteSupplierProduct": (()=>softDeleteSupplierProduct),
...
async function createSupplierProduct(supplierId, supplierRole, product) {
    try {
        const { productId, supplierId, stock, price, status, createdBy, createdByRole } = product;
        // Create the product in the database
        const newProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].supplierProduct.create({
            data: {
                productId,
                supplierId,
                stock,
...
const updateSupplierProduct = async (supplierId, supplierRole, supplierProductId, product)=>{
    try {
        const { supplierId, stock, price, status, updatedBy, updatedByRole } = product;
        ...
        const updatedProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].supplierProduct.update({
            where: {
...
const getProductsByFiltersAndStatus = async (type, filters, supplierId, status)=>{
    try {
...
const getProductsByStatus = async (type, supplierId, status)=>{
    try {
...
const checkSupplierProductForSupplier = async (supplierId, supplierProductId)=>{
    try {
...
const restoreSupplierProduct = async (supplierId, supplierRole, id)=>{
    try {
        // Restore the product
        const restoredSupplierProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].supplierProduct.update({
            where: {
                id
            },
            data: {
        ...
        return {
            status: false,
            message: "Error restoring Supplier Product"
        };
    }
};
const softDeleteSupplierProduct = async (supplierId, supplierRole, id)=>{
    try {
        // Soft delete the supplierProduct
        const updatedSupplierProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].supplierProduct.update({
            where: {
                id
            },
            data: {
        ...
        return {
            status: false,
            message: "Error soft deleting supplier product"
        };
    }
};
const deleteSupplierProduct = async (id)=>{
    try {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].supplierProduct.delete({
            where: {
                id
            }
        });
        ...
        return {
            status: false,
            message: "Error deleting supplier product"
        };
    }
};
...
"[project]/src/app/api/supplier/product/[supplierProductId]/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/app/models/supplier/product.ts [app-route] (ecmascript)");
;
;
;
;
...
async function GET(req) {
    try {
        ...
        const userExistence = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2f$authUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isUserExist"])(supplierId, String(supplierRole));
        ...
        const productResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkSupplierProductForSupplier"])(supplierId, supplierProductId);
        if (!productResult?.status || productResult.existsInSupplierProduct) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
...
async function PUT(req) {
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'POST request received for product updation');
        // Extract productId directly from the URL path
        const supplierProductId = Number(req.nextUrl.pathname.split('/').pop());
        ...
        const productResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkSupplierProductForSupplier"])(supplierId, supplierProductId);
        if (!productResult?.status || !productResult.existsInSupplierProduct) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'productResult - ', productResult);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                message: productResult.message
            }, {
        ...
        if (typeof supplierProduct?.productId !== 'number') {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Invalid supplierProduct: Missing productId or supplierProductId', supplierProduct);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: false,
                message: 'Invalid product or supplier mapping.'
            }, {
                status: 400
            });
        }
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Product payload updated:', productPayload);
        const productCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["updateSupplierProduct"])(supplierId, String(supplierRole), supplierProductId, productPayload);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Product updation failed:', productCreateResult?.message || 'Unknown error');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: productCreateResult?.message || 'Product updation failed'
        }, {
            status: 500
        });
    } catch (err) {
...
async function PATCH(req) {
    try {
        ...
        const restoreResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["restoreSupplierProduct"])(supplierId, String(supplierRole), supplierProductId);
        if (restoreResult?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'Product restored successfully:', restoreResult.restoredSupplierProduct);
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                product: restoreResult.restoredSupplierProduct
            }, {
                status: 200
            });
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Product restore failed');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Product restore failed'
        }, {
            status: 500
        });
    } catch (error) {
...
async function DELETE(req) {
    try {
        ...
        const result = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$supplier$2f$product$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["softDeleteSupplierProduct"])(Number(supplierId), String(supplierRole), supplierProductId); // Assuming softDeleteProduct marks the product as deleted
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `Soft delete request for product: ${supplierProductId}`, {
            supplierId
        });
        if (result?.status) {
            (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `Product soft deleted successfully: ${supplierProductId}`, {
                supplierId
            });
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', `Product not found or could not be deleted: ${supplierProductId}`, {
            supplierId
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Error during product deletion', {
            error
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__aea27948._.js.map