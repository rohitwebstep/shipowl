...
"[project]/.next-internal/server/app/api/high-rto/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
 ...
 */ const config = {
    "generator": {
        ...
        "output": {
            "value": "D:\\Webstep2\\NEW\\Shipping Owl\\May\\05\\shipping-owl\\prisma\\prisma\\generated\\client",
            "fromEnvVar": null
        },
        "config": {
            "engineType": "library"
        ...
        "previewFeatures": [],
        "sourceFilePath": "D:\\Webstep2\\NEW\\Shipping Owl\\May\\05\\shipping-owl\\prisma\\schema.prisma",
        "isCustomOutput": true
    },
    "relativeEnvPaths": {
        "rootEnvPath": null,
    ...
    "inlineSchemaHash": "bea150a6e9b472d21adfce747637e1af1f4c9d899f002870a85b282b95076f9f",
    "copyEngine": true
};
...
"[project]/src/app/api/high-rto/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('debug', 'POST request received for highRto creation');
        ...
        const isLocationHierarchyCorrectResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$location$2f$city$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isLocationHierarchyCorrect"])(cityIdNum, stateIdNum, countryIdNum);
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('info', 'HighRto payload created:', highRtoPayload);
        const highRtoCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$highRto$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createHighRto"])(adminId, String(adminRole), highRtoPayload);
        if (highRtoCreateResult?.status) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                highRto: highRtoCreateResult.highRto
            }, {
                status: 200
            });
        }
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'HighRto creation failed:', highRtoCreateResult?.message || 'Unknown error');
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: highRtoCreateResult?.message || 'HighRto creation failed'
        }, {
            status: 500
        });
    } catch (err) {
        const error = err instanceof Error ? err.message : 'Internal Server Error';
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'HighRto Creation Error:', error);
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error
        }, {
...
async function GET(req) {
    try {
        ...
        const highRtosResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$highRto$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getHighRtosByStatus"])('notDeleted');
        // Handle response based on highRtos result
        if (highRtosResult?.status) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                status: true,
                highRtos: highRtosResult.highRtos
            }, {
                status: 200
            });
        }
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'No highRtos found'
        }, {
            status: 404
        });
    } catch (error) {
        // Log and handle any unexpected errors
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$commonUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["logMessage"])('error', 'Error while fetching highRtos', {
            error
        });
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
            status: false,
            error: 'Failed to fetch highRtos due to an internal error'
        }, {
            status: 500
        });
    }
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__3bdfec59._.js.map