...
"[project]/.next-internal/server/app/api/admin/brand/route/actions.js [app-rsc] (server actions loader, ecmascript)": (function(__turbopack_context__) {
...
;
;
async function checkAdminPermission({ admin_id, panel, role, module, action }) {
    // Check if the user exists
    const userCheck = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2f$authUtils$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["isUserExist"])(admin_id, role);
    if (!userCheck.status) {
    ...
    const getPermissionsOfAdminResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$permission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getPermissionsOfAdminStaff"])(admin_id);
...
"[project]/src/app/api/admin/brand/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const permissionResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$utils$2f$auth$2f$checkAdminPermission$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["checkAdminPermission"])({
            admin_id: adminId,
        ...
        const brandCreateResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$brand$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createBrand"])(adminId, String(adminRole), brandPayload);
...
async function GET(req) {
    try {
        ...
        // Fetch all brands
        const brandsResult = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$models$2f$admin$2f$brand$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getBrandsByStatus"])("notDeleted");
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__1ecbedc8._.js.map