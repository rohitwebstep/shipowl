...
import { getBankAccountById, removeBankAccountImageByIndex } from '@/app/models/supplier/bankAccount';
...
export async function DELETE(req: NextRequest) {
  try {
    ...
    const bankAccountResult = await getBankAccountById(supplierId);
    ...
    const result = await removeBankAccountImageByIndex(bankAccountId, supplierId, imageType, imageIndex);
